...
<title>react-router | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="react-router" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/react-router/CHANGELOG.html" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/react-router/CHANGELOG.html" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="react-router" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"react-router","url":"http://localhost:4000/myportfolio.client/node_modules/react-router/CHANGELOG.html"}</script>
<!-- End Jekyll SEO tag -->
...
<!-- end custom head snippets -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <h1 id="react-router"><code class="language-plaintext highlighter-rouge">react-router</code></h1>
...
<ul>
  ...
  <li>Remove the <code class="language-plaintext highlighter-rouge">unstable_</code> prefix from the <a href="https://reactrouter.com/en/main/hooks/use-blocker"><code class="language-plaintext highlighter-rouge">useBlocker</code></a> hook as it’s been in use for enough time that we are confident in the API. We do not plan to remove the prefix from <code class="language-plaintext highlighter-rouge">unstable_usePrompt</code> due to differences in how browsers handle <code class="language-plaintext highlighter-rouge">window.confirm</code> that prevent React Router from guaranteeing consistent/correct behavior. (<a href="https://github.com/remix-run/react-router/pull/10991">#10991</a>)</li>
</ul>

<h3 id="patch-changes-3">Patch Changes</h3>

<ul>
  <li>Fix <code class="language-plaintext highlighter-rouge">useActionData</code> so it returns proper contextual action data and not <em>any</em> action data in the tree (<a href="https://github.com/remix-run/react-router/pull/11023">#11023</a>)</li>
  <li>
    <p>Fix bug in <code class="language-plaintext highlighter-rouge">useResolvedPath</code> that would cause <code class="language-plaintext highlighter-rouge">useResolvedPath(".")</code> in a splat route to lose the splat portion of the URL path. (<a href="https://github.com/remix-run/react-router/pull/10983">#10983</a>)</p>

    <ul>
      <li>⚠️ This fixes a quite long-standing bug specifically for <code class="language-plaintext highlighter-rouge">"."</code> paths inside a splat route which incorrectly dropped the splat portion of the URL. If you are relative routing via <code class="language-plaintext highlighter-rouge">"."</code> inside a splat route in your application you should double check that your logic is not relying on this buggy behavior and update accordingly.</li>
    </ul>
  </li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li>Fix <code class="language-plaintext highlighter-rouge">RouterProvider</code> <code class="language-plaintext highlighter-rouge">future</code> prop type to be a <code class="language-plaintext highlighter-rouge">Partial&lt;FutureConfig&gt;</code> so that not all flags must be specified (<a href="https://github.com/remix-run/react-router/pull/10900">#10900</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li>Ensure <code class="language-plaintext highlighter-rouge">useRevalidator</code> is referentially stable across re-renders if revalidations are not actively occurring (<a href="https://github.com/remix-run/react-router/pull/10707">#10707</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li>Fix loop in <code class="language-plaintext highlighter-rouge">unstable_useBlocker</code> when used with an unstable blocker function (<a href="https://github.com/remix-run/react-router/pull/10652">#10652</a>)</li>
...
<ul>
  <li>Strip <code class="language-plaintext highlighter-rouge">basename</code> from locations provided to <code class="language-plaintext highlighter-rouge">unstable_useBlocker</code> functions to match <code class="language-plaintext highlighter-rouge">useLocation</code> (<a href="https://github.com/remix-run/react-router/pull/10573">#10573</a>)</li>
  <li>Fix <code class="language-plaintext highlighter-rouge">generatePath</code> when passed a numeric <code class="language-plaintext highlighter-rouge">0</code> value parameter (<a href="https://github.com/remix-run/react-router/pull/10612">#10612</a>)</li>
...
<ul>
  <li>Fix <code class="language-plaintext highlighter-rouge">basename</code> duplication in descendant <code class="language-plaintext highlighter-rouge">&lt;Routes&gt;</code> inside a <code class="language-plaintext highlighter-rouge">&lt;RouterProvider&gt;</code> (<a href="https://github.com/remix-run/react-router/pull/10492">#10492</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li>Fix usage of <code class="language-plaintext highlighter-rouge">Component</code> API within descendant <code class="language-plaintext highlighter-rouge">&lt;Routes&gt;</code> (<a href="https://github.com/remix-run/react-router/pull/10434">#10434</a>)</li>
  <li>Fix bug when calling <code class="language-plaintext highlighter-rouge">useNavigate</code> from <code class="language-plaintext highlighter-rouge">&lt;Routes&gt;</code> inside a <code class="language-plaintext highlighter-rouge">&lt;RouterProvider&gt;</code> (<a href="https://github.com/remix-run/react-router/pull/10432">#10432</a>)</li>
  <li>Fix usage of <code class="language-plaintext highlighter-rouge">&lt;Navigate&gt;</code> in strict mode when using a data router (<a href="https://github.com/remix-run/react-router/pull/10435">#10435</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  ...
  <li>Fix bug preventing rendering of descendant <code class="language-plaintext highlighter-rouge">&lt;Routes&gt;</code> when <code class="language-plaintext highlighter-rouge">RouterProvider</code> errors existed (<a href="https://github.com/remix-run/react-router/pull/10374">#10374</a>)</li>
  ...
  <li>Fix detection of <code class="language-plaintext highlighter-rouge">useNavigate</code> in the render cycle by setting the <code class="language-plaintext highlighter-rouge">activeRef</code> in a layout effect, allowing the <code class="language-plaintext highlighter-rouge">navigate</code> function to be passed to child components and called in a <code class="language-plaintext highlighter-rouge">useEffect</code> there. (<a href="https://github.com/remix-run/react-router/pull/10394">#10394</a>)</li>
  ...
  <li>Allow <code class="language-plaintext highlighter-rouge">useRevalidator()</code> to resolve a loader-driven error boundary scenario (<a href="https://github.com/remix-run/react-router/pull/10369">#10369</a>)</li>
...
<ul>
  <li>Fix route ID generation when using Fragments in <code class="language-plaintext highlighter-rouge">createRoutesFromElements</code> (<a href="https://github.com/remix-run/react-router/pull/10193">#10193</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  ...
  <li>Update <code class="language-plaintext highlighter-rouge">&lt;Await&gt;</code> to accept <code class="language-plaintext highlighter-rouge">ReactNode</code> as children function return result (<a href="https://github.com/remix-run/react-router/pull/9896">#9896</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">&lt;Route path=":lang?/about&gt;</code> will match:
    <ul>
  ...
  <li><code class="language-plaintext highlighter-rouge">&lt;Route path="/multistep/:widget1?/widget2?/widget3?"&gt;</code> will match:
    <ul>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">&lt;Route path="/home?"&gt;</code> will match:
    <ul>
      <li><code class="language-plaintext highlighter-rouge">/</code></li>
      <li><code class="language-plaintext highlighter-rouge">/home</code></li>
    </ul>
  </li>
  <li><code class="language-plaintext highlighter-rouge">&lt;Route path="/fr?/about"&gt;</code> will match:
    <ul>
      <li><code class="language-plaintext highlighter-rouge">/about</code></li>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">useRoutes</code> should be able to return <code class="language-plaintext highlighter-rouge">null</code> when passing <code class="language-plaintext highlighter-rouge">locationArg</code> (<a href="https://github.com/remix-run/react-router/pull/9485">#9485</a>)</li>
  <li>fix <code class="language-plaintext highlighter-rouge">initialEntries</code> type in <code class="language-plaintext highlighter-rouge">createMemoryRouter</code> (<a href="https://github.com/remix-run/react-router/pull/9498">#9498</a>)</li>
  <li>Updated dependencies:
    <ul>
...
<ul>
  <li>Fix <code class="language-plaintext highlighter-rouge">IndexRouteObject</code> and <code class="language-plaintext highlighter-rouge">NonIndexRouteObject</code> types to make <code class="language-plaintext highlighter-rouge">hasErrorElement</code> optional (<a href="https://github.com/remix-run/react-router/pull/9394">#9394</a>)</li>
...
<h3 id="patch-changes-31">Patch Changes</h3>
...
<ul>
  <li>Create your router with <code class="language-plaintext highlighter-rouge">createMemoryRouter</code></li>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">@remix-run/router@1.0.0</code></li>
</ul>
