...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/ajv-keywords/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/ajv-keywords/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="ajv-keywords" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"ajv-keywords","url":"http://localhost:4000/myportfolio.client/node_modules/ajv-keywords/"}</script>
<!-- End Jekyll SEO tag -->
...
<p><a href="https://travis-ci.org/ajv-validator/ajv-keywords"><img src="https://travis-ci.org/ajv-validator/ajv-keywords.svg?branch=master" alt="Build Status" /></a>
...
<a href="https://coveralls.io/github/ajv-validator/ajv-keywords?branch=master"><img src="https://coveralls.io/repos/github/ajv-validator/ajv-keywords/badge.svg?branch=master" alt="Coverage Status" /></a>
<a href="https://app.dependabot.com/accounts/ajv-validator/repos/60477053"><img src="https://api.dependabot.com/badges/status?host=github&amp;repo=ajv-validator/ajv-keywords" alt="Dependabot" /></a>
...
<ul>
  ...
  <li><a href="#keywords">Keywords</a>
    <ul>
      ...
      <li><a href="#compound-keywords">Compound keywords</a>
        <ul>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">Ajv</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv</span><span class="dl">'</span><span class="p">);</span>
...
<span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">);</span>

<span class="nx">ajv</span><span class="p">.</span><span class="nx">validate</span><span class="p">({</span> <span class="na">instanceof</span><span class="p">:</span> <span class="dl">'</span><span class="s1">RegExp</span><span class="dl">'</span> <span class="p">},</span> <span class="sr">/.*/</span><span class="p">);</span> <span class="c1">// true</span>
<span class="nx">ajv</span><span class="p">.</span><span class="nx">validate</span><span class="p">({</span> <span class="na">instanceof</span><span class="p">:</span> <span class="dl">'</span><span class="s1">RegExp</span><span class="dl">'</span> <span class="p">},</span> <span class="dl">'</span><span class="s1">.*</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// false</span>
</code></pre></div></div>

<p>To add a single keyword:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="dl">'</span><span class="s1">instanceof</span><span class="dl">'</span><span class="p">);</span>
</code></pre></div></div>

<p>To add multiple keywords:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="p">[</span><span class="dl">'</span><span class="s1">typeof</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">instanceof</span><span class="dl">'</span><span class="p">]);</span>
</code></pre></div></div>

<p>To add a single keyword in browser (to avoid adding unused code):</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords/keywords/instanceof</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">);</span>
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>ajv.validate({ typeof: 'undefined' }, undefined); // true
...
<p>The value of the keyword should be a string (<code class="language-plaintext highlighter-rouge">"Object"</code>, <code class="language-plaintext highlighter-rouge">"Array"</code>, <code class="language-plaintext highlighter-rouge">"Function"</code>, <code class="language-plaintext highlighter-rouge">"Number"</code>, <code class="language-plaintext highlighter-rouge">"String"</code>, <code class="language-plaintext highlighter-rouge">"Date"</code>, <code class="language-plaintext highlighter-rouge">"RegExp"</code>, <code class="language-plaintext highlighter-rouge">"Promise"</code> or <code class="language-plaintext highlighter-rouge">"Buffer"</code>) or array of strings.</p>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>ajv.validate({ instanceof: 'Array' }, []); // true
...
<span class="kd">var</span> <span class="nx">instanceofDefinition</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">).</span><span class="kd">get</span><span class="p">(</span><span class="dl">'</span><span class="s1">instanceof</span><span class="dl">'</span><span class="p">).</span><span class="nx">definition</span><span class="p">;</span>
...
<span class="nx">ajv</span><span class="p">.</span><span class="nx">validate</span><span class="p">({</span> <span class="na">instanceof</span><span class="p">:</span> <span class="dl">'</span><span class="s1">MyClass</span><span class="dl">'</span> <span class="p">},</span> <span class="k">new</span> <span class="nx">MyClass</span><span class="p">);</span> <span class="c1">// true</span>
</code></pre></div></div>
...
<p>If the validated value is not a number the validation passes, otherwise to pass validation the value should be greater (or equal) than the first number and smaller (or equal) than the second number in the array. If <code class="language-plaintext highlighter-rouge">exclusiveRange</code> keyword is present in the same schema and its value is true, the validated value must not be equal to the range boundaries.</p>
...
<p>This keyword allows to use regular expressions with flags in schemas (the standard <code class="language-plaintext highlighter-rouge">pattern</code> keyword does not support flags).</p>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">foo</span><span class="p">:</span> <span class="p">{</span> <span class="na">regexp</span><span class="p">:</span> <span class="dl">'</span><span class="s1">/foo/i</span><span class="dl">'</span> <span class="p">},</span>
    <span class="na">bar</span><span class="p">:</span> <span class="p">{</span> <span class="na">regexp</span><span class="p">:</span> <span class="p">{</span> <span class="na">pattern</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">,</span> <span class="na">flags</span><span class="p">:</span> <span class="dl">'</span><span class="s1">i</span><span class="dl">'</span> <span class="p">}</span> <span class="p">}</span>
  <span class="p">}</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">validData</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Food</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">bar</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Barmen</span><span class="dl">'</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">invalidData</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">fog</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">bar</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bad</span><span class="dl">'</span>
<span class="p">};</span>
</code></pre></div></div>

<h4 id="formatmaximum--formatminimum-and-formatexclusivemaximum--formatexclusiveminimum"><code class="language-plaintext highlighter-rouge">formatMaximum</code> / <code class="language-plaintext highlighter-rouge">formatMinimum</code> and <code class="language-plaintext highlighter-rouge">formatExclusiveMaximum</code> / <code class="language-plaintext highlighter-rouge">formatExclusiveMinimum</code></h4>
...
<p>The value of keyword <code class="language-plaintext highlighter-rouge">formatMaximum</code> (<code class="language-plaintext highlighter-rouge">formatMinimum</code>) should be a string. This value is the maximum (minimum) allowed value for the data to be valid as determined by <code class="language-plaintext highlighter-rouge">format</code> keyword. If <code class="language-plaintext highlighter-rouge">format</code> is not present schema compilation will throw exception.</p>

<p>When this keyword is added, it defines comparison rules for formats <code class="language-plaintext highlighter-rouge">"date"</code>, <code class="language-plaintext highlighter-rouge">"time"</code> and <code class="language-plaintext highlighter-rouge">"date-time"</code>. Custom formats also can have comparison rules. See <a href="https://github.com/epoberezkin/ajv#api-addformat">addFormat</a> method.</p>

<p>The value of keyword <code class="language-plaintext highlighter-rouge">formatExclusiveMaximum</code> (<code class="language-plaintext highlighter-rouge">formatExclusiveMinimum</code>) should be a boolean value. These keyword cannot be used without <code class="language-plaintext highlighter-rouge">formatMaximum</code> (<code class="language-plaintext highlighter-rouge">formatMinimum</code>). If this keyword value is equal to <code class="language-plaintext highlighter-rouge">true</code>, the data to be valid should not be equal to the value in <code class="language-plaintext highlighter-rouge">formatMaximum</code> (<code class="language-plaintext highlighter-rouge">formatMinimum</code>) keyword.</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="p">[</span><span class="dl">'</span><span class="s1">formatMinimum</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">formatMaximum</span><span class="dl">'</span><span class="p">]);</span>

<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">format</span><span class="p">:</span> <span class="dl">'</span><span class="s1">date</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">formatMinimum</span><span class="p">:</span> <span class="dl">'</span><span class="s1">2016-02-06</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">formatMaximum</span><span class="p">:</span> <span class="dl">'</span><span class="s1">2016-12-27</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">formatExclusiveMaximum</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">}</span>

<span class="kd">var</span> <span class="nx">validDataList</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">2016-02-06</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">2016-12-26</span><span class="dl">'</span><span class="p">,</span> <span class="mi">1</span><span class="p">];</span>

<span class="kd">var</span> <span class="nx">invalidDataList</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">2016-02-05</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">2016-12-27</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">abc</span><span class="dl">'</span><span class="p">];</span>
</code></pre></div></div>
...
<ul>
  <li>a stand alone string cannot be transformed. ie <code class="language-plaintext highlighter-rouge">data = 'a'; ajv.validate(schema, data);</code></li>
  <li>currently cannot work with <code class="language-plaintext highlighter-rouge">ajv-pack</code></li>
</ul>
...
<ul>
  ...
  <li><code class="language-plaintext highlighter-rouge">trimLeft</code>: remove whitespace from start</li>
  <li><code class="language-plaintext highlighter-rouge">trimRight</code>: remove whitespace from end</li>
  <li><code class="language-plaintext highlighter-rouge">toLowerCase</code>: case string to all lower case</li>
  <li><code class="language-plaintext highlighter-rouge">toUpperCase</code>: case string to all upper case</li>
  <li><code class="language-plaintext highlighter-rouge">toEnumCase</code>: case string to match case in schema</li>
</ul>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="p">[</span><span class="dl">'</span><span class="s1">transform</span><span class="dl">'</span><span class="p">]);</span>
...
<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">items</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="na">transform</span><span class="p">:[</span><span class="dl">'</span><span class="s1">trim</span><span class="dl">'</span><span class="p">,</span><span class="dl">'</span><span class="s1">toLowerCase</span><span class="dl">'</span><span class="p">]</span>
  <span class="p">}</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">data</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">  MixCase  </span><span class="dl">'</span><span class="p">];</span>
...
<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">items</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">type</span><span class="p">:</span><span class="dl">'</span><span class="s1">string</span><span class="dl">'</span><span class="p">,</span>
    <span class="na">transform</span><span class="p">:[</span><span class="dl">'</span><span class="s1">trim</span><span class="dl">'</span><span class="p">,</span><span class="dl">'</span><span class="s1">toEnumCase</span><span class="dl">'</span><span class="p">],</span>
    <span class="na">enum</span><span class="p">:[</span><span class="dl">'</span><span class="s1">pH</span><span class="dl">'</span><span class="p">]</span>
  <span class="p">}</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">data</span> <span class="o">=</span> <span class="p">[</span><span class="dl">'</span><span class="s1">ph</span><span class="dl">'</span><span class="p">,</span><span class="dl">'</span><span class="s1"> Ph</span><span class="dl">'</span><span class="p">,</span><span class="dl">'</span><span class="s1">PH</span><span class="dl">'</span><span class="p">,</span><span class="dl">'</span><span class="s1">pH </span><span class="dl">'</span><span class="p">];</span>
<span class="nx">ajv</span><span class="p">.</span><span class="nx">validate</span><span class="p">(</span><span class="nx">schema</span><span class="p">,</span> <span class="nx">data</span><span class="p">);</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span> <span class="na">uniqueItemProperties</span><span class="p">:</span> <span class="p">[</span> <span class="dl">"</span><span class="s2">id</span><span class="dl">"</span><span class="p">,</span> <span class="dl">"</span><span class="s2">name</span><span class="dl">"</span> <span class="p">]</span> <span class="p">};</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">foo</span><span class="p">:</span> <span class="p">{</span><span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">number</span><span class="dl">'</span><span class="p">},</span>
    <span class="na">bar</span><span class="p">:</span> <span class="p">{</span><span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">number</span><span class="dl">'</span><span class="p">}</span>
  <span class="p">}</span>
  <span class="nl">allRequired</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">};</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">anyRequired</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">]</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">validData</span> <span class="o">=</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="mi">1</span> <span class="p">};</span>
<span class="kd">var</span> <span class="nx">alsoValidData</span> <span class="o">=</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="mi">1</span><span class="p">,</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">2</span> <span class="p">};</span>

<span class="kd">var</span> <span class="nx">invalidDataList</span> <span class="o">=</span> <span class="p">[</span> <span class="p">{},</span> <span class="p">{</span> <span class="na">baz</span><span class="p">:</span> <span class="mi">3</span> <span class="p">}</span> <span class="p">];</span>
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">oneRequired</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">]</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">validData</span> <span class="o">=</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="mi">1</span> <span class="p">};</span>
<span class="kd">var</span> <span class="nx">alsoValidData</span> <span class="o">=</span> <span class="p">{</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">2</span><span class="p">,</span> <span class="na">baz</span><span class="p">:</span> <span class="mi">3</span> <span class="p">};</span>

<span class="kd">var</span> <span class="nx">invalidDataList</span> <span class="o">=</span> <span class="p">[</span> <span class="p">{},</span> <span class="p">{</span> <span class="na">baz</span><span class="p">:</span> <span class="mi">3</span> <span class="p">},</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="mi">1</span><span class="p">,</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">2</span> <span class="p">}</span> <span class="p">];</span>
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span> <span class="na">patternRequired</span><span class="p">:</span> <span class="p">[</span> <span class="dl">'</span><span class="s1">f.*o</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">b.*r</span><span class="dl">'</span> <span class="p">]</span> <span class="p">};</span>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>var schema = { prohibited: ['foo', 'bar']};
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">deepProperties</span><span class="p">:</span> <span class="p">{</span>
    <span class="dl">"</span><span class="s2">/users/1/role</span><span class="dl">"</span><span class="p">:</span> <span class="p">{</span> <span class="dl">"</span><span class="s2">enum</span><span class="dl">"</span><span class="p">:</span> <span class="p">[</span><span class="dl">"</span><span class="s2">admin</span><span class="dl">"</span><span class="p">]</span> <span class="p">}</span>
  <span class="p">}</span>
<span class="p">};</span>
...
<h3 id="compound-keywords">Compound keywords</h3>

<h4 id="switch-deprecated"><code class="language-plaintext highlighter-rouge">switch</code> (deprecated)</h4>

<p><strong>Please note</strong>: this keyword is provided to preserve backward compatibility with previous versions of Ajv. It is strongly recommended to use <code class="language-plaintext highlighter-rouge">if</code>/<code class="language-plaintext highlighter-rouge">then</code>/<code class="language-plaintext highlighter-rouge">else</code> keywords instead, as they have been added to the draft-07 of JSON Schema specification.</p>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">if</code> (optional) - the value is JSON-schema</li>
  <li><code class="language-plaintext highlighter-rouge">then</code> (required) - the value is JSON-schema or boolean</li>
  <li><code class="language-plaintext highlighter-rouge">continue</code> (optional) - the value is boolean</li>
</ul>
...
<ol>
  <li><code class="language-plaintext highlighter-rouge">if</code>:
    <ol>
      <li><code class="language-plaintext highlighter-rouge">if</code> property is JSON-schema according to which the data is:
        <ol>
          <li>valid =&gt; go to step 2.</li>
          <li>invalid =&gt; go to the NEXT clause, if this was the last clause the validation of <code class="language-plaintext highlighter-rouge">switch</code> SUCCEEDS.</li>
        </ol>
      </li>
      <li><code class="language-plaintext highlighter-rouge">if</code> property is absent =&gt; go to step 2.</li>
    </ol>
  </li>
  <li><code class="language-plaintext highlighter-rouge">then</code>:
    <ol>
      <li><code class="language-plaintext highlighter-rouge">then</code> property is <code class="language-plaintext highlighter-rouge">true</code> or it is JSON-schema according to which the data is valid =&gt; go to step 3.</li>
      <li><code class="language-plaintext highlighter-rouge">then</code> property is <code class="language-plaintext highlighter-rouge">false</code> or it is JSON-schema according to which the data is invalid =&gt; the validation of <code class="language-plaintext highlighter-rouge">switch</code> FAILS.</li>
    </ol>
  </li>
  <li><code class="language-plaintext highlighter-rouge">continue</code>:
    <ol>
      <li><code class="language-plaintext highlighter-rouge">continue</code> property is <code class="language-plaintext highlighter-rouge">true</code> =&gt; go to the NEXT clause, if this was the last clause the validation of <code class="language-plaintext highlighter-rouge">switch</code> SUCCEEDS.</li>
      <li><code class="language-plaintext highlighter-rouge">continue</code> property is <code class="language-plaintext highlighter-rouge">false</code> or absent =&gt; validation of <code class="language-plaintext highlighter-rouge">switch</code> SUCCEEDS.</li>
    </ol>
  </li>
</ol>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="dl">'</span><span class="s1">switch</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">invalidItems</span> <span class="o">=</span> <span class="p">[</span><span class="mi">1</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">2000</span><span class="p">,</span> <span class="mi">11</span><span class="p">,</span> <span class="mi">57</span><span class="p">,</span> <span class="mi">123</span><span class="p">,</span> <span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">];</span>
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="p">{</span>
  ...
  <span class="nx">items</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="k">else</span><span class="p">:</span> <span class="p">{</span>
      <span class="nl">if</span><span class="p">:</span> <span class="p">{</span> <span class="na">maximum</span><span class="p">:</span> <span class="mi">100</span> <span class="p">},</span>
      ...
      <span class="k">else</span><span class="p">:</span> <span class="p">{</span>
        <span class="nl">if</span><span class="p">:</span> <span class="p">{</span> <span class="na">maximum</span><span class="p">:</span> <span class="mi">1000</span> <span class="p">},</span>
...
<p><strong>Please note</strong>: these keywords require Ajv <code class="language-plaintext highlighter-rouge">$data</code> option to support <a href="https://github.com/epoberezkin/ajv/tree/5.0.2-beta.0#data-reference">$data reference</a>.</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">)(</span><span class="nx">ajv</span><span class="p">,</span> <span class="dl">'</span><span class="s1">select</span><span class="dl">'</span><span class="p">);</span>

<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">type</span><span class="p">:</span> <span class="nx">object</span><span class="p">,</span>
  <span class="na">required</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">kind</span><span class="dl">'</span><span class="p">],</span>
  <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">kind</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">string</span><span class="dl">'</span> <span class="p">}</span>
  <span class="p">},</span>
  <span class="na">select</span><span class="p">:</span> <span class="p">{</span> <span class="na">$data</span><span class="p">:</span> <span class="dl">'</span><span class="s1">0/kind</span><span class="dl">'</span> <span class="p">},</span>
  <span class="na">selectCases</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">foo</span><span class="p">:</span> <span class="p">{</span>
      <span class="na">required</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">],</span>
      <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">kind</span><span class="p">:</span> <span class="p">{},</span>
        <span class="na">foo</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">string</span><span class="dl">'</span> <span class="p">}</span>
      <span class="p">},</span>
    ...
    <span class="na">bar</span><span class="p">:</span> <span class="p">{</span>
      <span class="na">required</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">],</span>
      <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">kind</span><span class="p">:</span> <span class="p">{},</span>
        <span class="na">bar</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">number</span><span class="dl">'</span> <span class="p">}</span>
      <span class="p">},</span>
  ...
  <span class="na">selectDefault</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">propertyNames</span><span class="p">:</span> <span class="p">{</span>
      <span class="na">not</span><span class="p">:</span> <span class="p">{</span> <span class="na">enum</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">]</span> <span class="p">}</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">};</span>

<span class="kd">var</span> <span class="nx">validDataList</span> <span class="o">=</span> <span class="p">[</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any</span><span class="dl">'</span> <span class="p">},</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">,</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">1</span> <span class="p">},</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">anything_else</span><span class="dl">'</span><span class="p">,</span> <span class="na">not_bar_or_foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any value</span><span class="dl">'</span> <span class="p">}</span>
<span class="p">];</span>

<span class="kd">var</span> <span class="nx">invalidDataList</span> <span class="o">=</span> <span class="p">[</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span> <span class="p">},</span> <span class="c1">// no propery foo</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span> <span class="p">},</span> <span class="c1">// no propery bar</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">foo</span><span class="dl">'</span><span class="p">,</span> <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any</span><span class="dl">'</span><span class="p">,</span> <span class="na">another</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any value</span><span class="dl">'</span> <span class="p">},</span> <span class="c1">// additional property</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">,</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">1</span><span class="p">,</span> <span class="na">another</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any value</span><span class="dl">'</span> <span class="p">},</span> <span class="c1">// additional property</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">anything_else</span><span class="dl">'</span><span class="p">,</span> <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">any</span><span class="dl">'</span> <span class="p">}</span> <span class="c1">// property foo not allowed</span>
  <span class="p">{</span> <span class="na">kind</span><span class="p">:</span> <span class="dl">'</span><span class="s1">anything_else</span><span class="dl">'</span><span class="p">,</span> <span class="na">bar</span><span class="p">:</span> <span class="mi">1</span> <span class="p">}</span> <span class="c1">// property bar not allowed</span>
<span class="p">];</span>
</code></pre></div></div>

<p><strong>Please note</strong>: the current implementation is BETA. It does not allow using relative URIs in $ref keywords in schemas in <code class="language-plaintext highlighter-rouge">selectCases</code> and <code class="language-plaintext highlighter-rouge">selectDefault</code> that point outside of these schemas. The workaround is to use absolute URIs (that can point to any (sub-)schema added to Ajv, including those inside the current root schema where <code class="language-plaintext highlighter-rouge">select</code> is used). See <a href="https://github.com/epoberezkin/ajv-keywords/blob/v2.0.0/spec/tests/select.json#L314">tests</a>.</p>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">dynamicDefaults</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">ts</span><span class="p">:</span> <span class="dl">'</span><span class="s1">datetime</span><span class="dl">'</span><span class="p">,</span>
    <span class="na">r</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">randomint</span><span class="dl">'</span><span class="p">,</span> <span class="na">args</span><span class="p">:</span> <span class="p">{</span> <span class="na">max</span><span class="p">:</span> <span class="mi">100</span> <span class="p">}</span> <span class="p">},</span>
    <span class="na">id</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">seq</span><span class="dl">'</span><span class="p">,</span> <span class="na">args</span><span class="p">:</span> <span class="p">{</span> <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">id</span><span class="dl">'</span> <span class="p">}</span> <span class="p">}</span>
  <span class="p">},</span>
  <span class="na">properties</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">ts</span><span class="p">:</span> <span class="p">{</span>
      <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">string</span><span class="dl">'</span><span class="p">,</span>
      <span class="na">format</span><span class="p">:</span> <span class="dl">'</span><span class="s1">date-time</span><span class="dl">'</span>
    <span class="p">},</span>
    <span class="na">r</span><span class="p">:</span> <span class="p">{</span>
      ...
      <span class="na">exclusiveMaximum</span><span class="p">:</span> <span class="mi">100</span>
    <span class="p">},</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">allOf</span><span class="p">:</span> <span class="p">[</span>
    <span class="p">{</span>
      <span class="na">dynamicDefaults</span><span class="p">:</span> <span class="p">{</span>
        <span class="na">ts</span><span class="p">:</span> <span class="dl">'</span><span class="s1">datetime</span><span class="dl">'</span><span class="p">,</span>
        <span class="na">r</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">randomint</span><span class="dl">'</span><span class="p">,</span> <span class="na">args</span><span class="p">:</span> <span class="p">{</span> <span class="na">min</span><span class="p">:</span> <span class="mi">5</span><span class="p">,</span> <span class="na">max</span><span class="p">:</span> <span class="mi">100</span> <span class="p">}</span> <span class="p">},</span>
        <span class="na">id</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">seq</span><span class="dl">'</span><span class="p">,</span> <span class="na">args</span><span class="p">:</span> <span class="p">{</span> <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">id</span><span class="dl">'</span> <span class="p">}</span> <span class="p">}</span>
      <span class="p">}</span>
    <span class="p">},</span>
    <span class="p">{</span>
...
<span class="kd">var</span> <span class="nx">data</span> <span class="o">=</span> <span class="p">{</span> <span class="na">ts</span><span class="p">:</span> <span class="dl">''</span><span class="p">,</span> <span class="na">r</span><span class="p">:</span> <span class="kc">null</span> <span class="p">};</span>
<span class="nx">ajv</span><span class="p">.</span><span class="nx">validate</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span> <span class="c1">// true</span>
<span class="nx">data</span><span class="p">;</span> <span class="c1">// { ts: '2016-12-01T22:07:28.829Z', r: 25, id: 0 }</span>
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">uuid</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">definition</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">ajv-keywords</span><span class="dl">'</span><span class="p">).</span><span class="kd">get</span><span class="p">(</span><span class="dl">'</span><span class="s1">dynamicDefaults</span><span class="dl">'</span><span class="p">).</span><span class="nx">definition</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">dynamicDefaults</span><span class="p">:</span> <span class="p">{</span> <span class="na">id</span><span class="p">:</span> <span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span> <span class="p">},</span>
  <span class="na">properties</span><span class="p">:</span> <span class="p">{</span> <span class="na">id</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">string</span><span class="dl">'</span><span class="p">,</span> <span class="na">format</span><span class="p">:</span> <span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span> <span class="p">}</span> <span class="p">}</span>
<span class="p">};</span>
...
<span class="kd">function</span> <span class="nx">getUuid</span><span class="p">(</span><span class="nx">args</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">version</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">v</span><span class="dl">'</span> <span class="o">+</span> <span class="p">(</span><span class="nx">arvs</span> <span class="o">&amp;&amp;</span> <span class="nx">args</span><span class="p">.</span><span class="nx">v</span> <span class="o">||</span> <span class="mi">4</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">schema</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">dynamicDefaults</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">id1</span><span class="p">:</span> <span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span><span class="p">,</span> <span class="c1">// v4</span>
    <span class="na">id2</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span><span class="p">,</span> <span class="na">v</span><span class="p">:</span> <span class="mi">4</span> <span class="p">},</span> <span class="c1">// v4</span>
    <span class="na">id3</span><span class="p">:</span> <span class="p">{</span> <span class="na">func</span><span class="p">:</span> <span class="dl">'</span><span class="s1">uuid</span><span class="dl">'</span><span class="p">,</span> <span class="na">v</span><span class="p">:</span> <span class="mi">1</span> <span class="p">}</span> <span class="c1">// v1</span>
  <span class="p">}</span>
<span class="p">};</span>
</code></pre></div></div>
