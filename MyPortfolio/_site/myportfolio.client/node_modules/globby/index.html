...
<title>globby | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="globby" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/globby/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/globby/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="globby" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"globby","url":"http://localhost:4000/myportfolio.client/node_modules/globby/"}</script>
<!-- End Jekyll SEO tag -->
...
<ul>
  ...
  <li>Supports <code class="language-plaintext highlighter-rouge">.gitignore</code></li>
</ul>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">globby</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">globby</span><span class="dl">'</span><span class="p">);</span>
...
<span class="p">(</span><span class="k">async</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="k">for</span> <span class="k">await</span> <span class="p">(</span><span class="kd">const</span> <span class="nx">path</span> <span class="k">of</span> <span class="nx">globby</span><span class="p">.</span><span class="nx">stream</span><span class="p">(</span><span class="dl">'</span><span class="s1">*.tmp</span><span class="dl">'</span><span class="p">))</span> <span class="p">{</span>
...
<p>Returns an <code class="language-plaintext highlighter-rouge">object[]</code> in the format <code class="language-plaintext highlighter-rouge">{pattern: string, options: Object}</code>, which can be passed as arguments to <a href="https://github.com/mrmlnc/fast-glob"><code class="language-plaintext highlighter-rouge">fast-glob</code></a>. This is useful for other globbing-related packages.</p>
...
<p>Returns a <code class="language-plaintext highlighter-rouge">Promise&lt;(path: string) =&gt; boolean&gt;</code> indicating whether a given path is ignored via a <code class="language-plaintext highlighter-rouge">.gitignore</code> file.</p>

<p>Takes <code class="language-plaintext highlighter-rouge">cwd?: string</code> and <code class="language-plaintext highlighter-rouge">ignore?: string[]</code> as options. <code class="language-plaintext highlighter-rouge">.gitignore</code> files matched by the ignore config are not used for the resulting filter function.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="p">{</span><span class="nx">gitignore</span><span class="p">}</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">globby</span><span class="dl">'</span><span class="p">);</span>

<span class="p">(</span><span class="k">async</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="kd">const</span> <span class="nx">isIgnored</span> <span class="o">=</span> <span class="k">await</span> <span class="nx">gitignore</span><span class="p">();</span>
...
<p>Returns a <code class="language-plaintext highlighter-rouge">(path: string) =&gt; boolean</code> indicating whether a given path is ignored via a <code class="language-plaintext highlighter-rouge">.gitignore</code> file.</p>

<p>Takes the same options as <code class="language-plaintext highlighter-rouge">globby.gitignore</code>.</p>
