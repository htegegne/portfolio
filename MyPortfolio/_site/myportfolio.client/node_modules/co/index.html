...
<title>co | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="co" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/co/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/co/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="co" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"co","url":"http://localhost:4000/myportfolio.client/node_modules/co/"}</script>
<!-- End Jekyll SEO tag -->
...
<p><code class="language-plaintext highlighter-rouge">co@4.0.0</code> has been released, which now relies on promises.
  It is a stepping stone towards <a href="https://github.com/lukehoban/ecmascript-asyncawait">ES7 async/await</a>.
  The primary API change is how <code class="language-plaintext highlighter-rouge">co()</code> is invoked.
  Before, <code class="language-plaintext highlighter-rouge">co</code> returned a “thunk”, which you then called with a callback and optional arguments.
  Now, <code class="language-plaintext highlighter-rouge">co()</code> returns a promise.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">co</span><span class="p">(</span><span class="kd">function</span><span class="o">*</span> <span class="p">()</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">result</span> <span class="o">=</span> <span class="k">yield</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="kc">true</span><span class="p">);</span>
...
<p>If you want to convert a <code class="language-plaintext highlighter-rouge">co</code>-generator-function into a regular function that returns a promise,
  you now use <code class="language-plaintext highlighter-rouge">co.wrap(fn*)</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">fn</span> <span class="o">=</span> <span class="nx">co</span><span class="p">.</span><span class="nx">wrap</span><span class="p">(</span><span class="kd">function</span><span class="o">*</span> <span class="p">(</span><span class="nx">val</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="k">yield</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="nx">val</span><span class="p">);</span>
<span class="p">});</span>
...
<p><code class="language-plaintext highlighter-rouge">co@4+</code> requires a <code class="language-plaintext highlighter-rouge">Promise</code> implementation.
  For versions of node <code class="language-plaintext highlighter-rouge">&lt; 0.11</code> and for many older browsers,
  you should/must include your own <code class="language-plaintext highlighter-rouge">Promise</code> polyfill.</p>

<p>When using node 0.11.x or greater, you must use the <code class="language-plaintext highlighter-rouge">--harmony-generators</code>
  flag or just <code class="language-plaintext highlighter-rouge">--harmony</code> to get access to generators.</p>
...
<p>io.js is supported out of the box, you can use <code class="language-plaintext highlighter-rouge">co</code> without flags or polyfills.</p>

<h2 id="installation">Installation</h2>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ npm install co
</code></pre></div></div>

<h2 id="associated-libraries">Associated libraries</h2>

<p>Any library that returns promises work well with <code class="language-plaintext highlighter-rouge">co</code>.</p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">co</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">co</span><span class="dl">'</span><span class="p">);</span>
...
<span class="nx">co</span><span class="p">(</span><span class="kd">function</span> <span class="o">*</span><span class="p">(){</span>
  ...
  <span class="kd">var</span> <span class="nx">b</span> <span class="o">=</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="mi">2</span><span class="p">);</span>
  <span class="kd">var</span> <span class="nx">c</span> <span class="o">=</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="mi">3</span><span class="p">);</span>
...
<span class="nx">co</span><span class="p">(</span><span class="kd">function</span> <span class="o">*</span><span class="p">(){</span>
  <span class="k">try</span> <span class="p">{</span>
    <span class="k">yield</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">reject</span><span class="p">(</span><span class="k">new</span> <span class="nb">Error</span><span class="p">(</span><span class="dl">'</span><span class="s1">boom</span><span class="dl">'</span><span class="p">));</span>
...
<p>The <code class="language-plaintext highlighter-rouge">yieldable</code> objects currently supported are:</p>
...
<p>Nested <code class="language-plaintext highlighter-rouge">yieldable</code> objects are supported, meaning you can nest
...
be removed in future versions of <code class="language-plaintext highlighter-rouge">co</code>.</p>

<h3 id="arrays">Arrays</h3>

<p><code class="language-plaintext highlighter-rouge">yield</code>ing an array will resolve all the <code class="language-plaintext highlighter-rouge">yieldables</code> in parallel.</p>
...
<p>Just like arrays, objects resolve all <code class="language-plaintext highlighter-rouge">yieldable</code>s in parallel.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">co</span><span class="p">(</span><span class="kd">function</span><span class="o">*</span> <span class="p">()</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">res</span> <span class="o">=</span> <span class="k">yield</span> <span class="p">{</span>
    <span class="mi">1</span><span class="p">:</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="mi">1</span><span class="p">),</span>
    <span class="mi">2</span><span class="p">:</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="mi">2</span><span class="p">),</span>
  <span class="p">};</span>
...
<p>Any generator or generator function you can pass into <code class="language-plaintext highlighter-rouge">co</code>
can be yielded as well. This should generally be avoided
as we should be moving towards spec-compliant <code class="language-plaintext highlighter-rouge">Promise</code>s instead.</p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">co</span><span class="p">(</span><span class="kd">function</span><span class="o">*</span> <span class="p">()</span> <span class="p">{</span>
  <span class="k">return</span> <span class="k">yield</span> <span class="nb">Promise</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="kc">true</span><span class="p">);</span>
...
<p>Convert a generator into a regular function that returns a <code class="language-plaintext highlighter-rouge">Promise</code>.</p>
