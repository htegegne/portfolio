...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/webpack/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/webpack/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="portfolio" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"portfolio","url":"http://localhost:4000/myportfolio.client/node_modules/webpack/"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>yarn add webpack <span class="nt">--dev</span>
</code></pre></div></div>
...
<p>Webpack supports all browsers that are <a href="https://kangax.github.io/compat-table/es5/">ES5-compliant</a> (IE8 and below are not supported).
Webpack also needs <code class="language-plaintext highlighter-rouge">Promise</code> for <code class="language-plaintext highlighter-rouge">import()</code> and <code class="language-plaintext highlighter-rouge">require.ensure()</code>. If you want to support older browsers, you will need to <a href="https://webpack.js.org/guides/shimming/">load a polyfill</a> before using these expressions.</p>

<h2 align="center">Concepts</h2>

<h3 id="plugins"><a href="https://webpack.js.org/plugins/">Plugins</a></h3>

<p>Webpack has a <a href="https://webpack.js.org/plugins/">rich plugin
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: left">Simplifies creation of HTML files (<code class="language-plaintext highlighter-rouge">index.html</code>) to serve your bundles</td>
    </tr>
    <tr>
      <td style="text-align: center"><a href="https://github.com/webdiscus/pug-plugin">pug-plugin</a></td>
      <td style="text-align: center"><img src="https://img.shields.io/npm/v/pug-plugin.svg" alt="pug-plugin-npm" /></td>
      <td style="text-align: center"><img src="https://packagephobia.com/badge?p=pug-plugin" alt="pug-plugin-size" /></td>
      <td style="text-align: left">Renders Pug files to HTML, extracts JS and CSS from sources specified directly in Pug.</td>
    </tr>
  </tbody>
</table>
...
<p>Webpack enables the use of loaders to preprocess files. This allows you to bundle
<strong>any static resource</strong> way beyond JavaScript. You can easily <a href="https://webpack.js.org/api/loaders/">write your own
loaders</a> using Node.js.</p>

<p>Loaders are activated by using <code class="language-plaintext highlighter-rouge">loadername!</code> prefixes in <code class="language-plaintext highlighter-rouge">require()</code> statements,
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align: center"><a href="https://github.com/TypeStrong/ts-loader"><img width="48" height="48" src="https://raw.githubusercontent.com/microsoft/TypeScript-Website/f407e1ae19e5e990d9901ac8064a32a8cc60edf0/packages/typescriptlang-org/static/branding/ts-logo-128.svg" /></a></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align: center"><a href="https://github.com/webpack-contrib/html-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/html5-2.svg" /></a></td>
    ...
    <tr>
      <td style="text-align: center"><a href="https://github.com/webdiscus/pug-loader"><img width="48" height="48" src="https://cdn.rawgit.com/pugjs/pug-logo/master/SVG/pug-final-logo-_-colour-128.svg" /></a></td>
      <td style="text-align: center"><img src="https://img.shields.io/npm/v/@webdiscus/pug-loader.svg" alt="pug3-npm" /></td>
      <td style="text-align: center"><img src="https://packagephobia.com/badge?p=@webdiscus/pug-loader" alt="pug3-size" /></td>
      <td style="text-align: left">Compiles Pug to a function or HTML string, useful for use with Vue, React, Angular</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align: center"><a href="https://github.com/webpack-contrib/style-loader"><code class="language-plaintext highlighter-rouge">&lt;style&gt;</code></a></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: left">Process HTML &amp; CSS with preprocessor of choice and <code class="language-plaintext highlighter-rouge">require()</code> Web Components like first-class modules</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align: center"><a href="https://github.com/sveltejs/svelte-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/svelte-1.svg" /></a></td>
      <td style="text-align: center"><img src="https://img.shields.io/npm/v/svelte-loader.svg" alt="svelte-npm" /></td>
      <td style="text-align: center"><img src="https://packagephobia.com/badge?p=svelte-loader" alt="svelte-size" /></td>
      <td style="text-align: left">Official Svelte loader</td>
    </tr>
  </tbody>
</table>
...
<p>If you create a loader or plugin, we would &lt;3 for you to open source it, and put it on npm. We follow the <code class="language-plaintext highlighter-rouge">x-loader</code>, <code class="language-plaintext highlighter-rouge">x-webpack-plugin</code> naming convention.</p>
...
a question to <a href="https://stackoverflow.com/tags/webpack">StackOverflow with the webpack tag</a>. It is much easier to answer questions that include your webpack.config.js and relevant files! So if you can provide them, we’d be extremely grateful (and more likely to help you find the answer!)</p>
