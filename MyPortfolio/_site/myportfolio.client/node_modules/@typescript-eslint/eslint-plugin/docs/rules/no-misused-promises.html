...
<p>If you don’t want to check conditionals, you can configure the rule with <code class="language-plaintext highlighter-rouge">"checksConditionals": false</code>:</p>
...
<p>For example, if you don’t mind that passing a <code class="language-plaintext highlighter-rouge">() =&gt; Promise&lt;void&gt;</code> to a <code class="language-plaintext highlighter-rouge">() =&gt; void</code> parameter or JSX attribute can lead to a floating unhandled Promise:</p>
...
<p>If you don’t want to check object spreads, you can add this configuration:</p>
