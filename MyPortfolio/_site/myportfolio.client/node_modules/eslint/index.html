...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/eslint/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/eslint/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="portfolio" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"portfolio","url":"http://localhost:4000/myportfolio.client/node_modules/eslint/"}</script>
<!-- End Jekyll SEO tag -->
...
<!-- end custom head snippets -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <p><a href="https://www.npmjs.com/package/eslint"><img src="https://img.shields.io/npm/v/eslint.svg" alt="npm version" /></a>
...
<p>Prerequisites: <a href="https://nodejs.org/">Node.js</a> (<code class="language-plaintext highlighter-rouge">^12.22.0</code>, <code class="language-plaintext highlighter-rouge">^14.17.0</code>, or <code class="language-plaintext highlighter-rouge">&gt;=16.0.0</code>) built with SSL support. (If you are using an official Node.js distribution, SSL is always built in.)</p>

<p>You can install and configure ESLint using this command:</p>

<div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm init @eslint/config
</code></pre></div></div>

<p>After that, you can run ESLint on any file or directory like this:</p>

<div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code>./node_modules/.bin/eslint yourfile.js
</code></pre></div></div>

<h2 id="configuration">Configuration</h2>

<p>After running <code class="language-plaintext highlighter-rouge">npm init @eslint/config</code>, you’ll have an <code class="language-plaintext highlighter-rouge">.eslintrc</code> file in your directory. In it, you’ll see some rules configured like this:</p>
...
<p>The names <code class="language-plaintext highlighter-rouge">"semi"</code> and <code class="language-plaintext highlighter-rouge">"quotes"</code> are the names of <a href="https://eslint.org/docs/rules">rules</a> in ESLint. The first value is the error level of the rule and can be one of these values:</p>

<ul>
  <li><code class="language-plaintext highlighter-rouge">"off"</code> or <code class="language-plaintext highlighter-rouge">0</code> - turn the rule off</li>
  <li><code class="language-plaintext highlighter-rouge">"warn"</code> or <code class="language-plaintext highlighter-rouge">1</code> - turn the rule on as a warning (doesn’t affect exit code)</li>
  <li><code class="language-plaintext highlighter-rouge">"error"</code> or <code class="language-plaintext highlighter-rouge">2</code> - turn the rule on as an error (exit code will be 1)</li>
</ul>
...
<ul>
  <li>Make sure your plugins (and ESLint) are both in your project’s <code class="language-plaintext highlighter-rouge">package.json</code> as devDependencies (or dependencies, if your project uses ESLint at runtime).</li>
  <li>Make sure you have run <code class="language-plaintext highlighter-rouge">npm install</code> and all your dependencies are installed.</li>
  <li>Make sure your plugins’ peerDependencies have been installed as well. You can use <code class="language-plaintext highlighter-rouge">npm view eslint-plugin-myplugin peerDependencies</code> to see what peer dependencies <code class="language-plaintext highlighter-rouge">eslint-plugin-myplugin</code> has.</li>
</ul>
...
<p>Lock files like <code class="language-plaintext highlighter-rouge">package-lock.json</code> are helpful for deployed applications. They ensure that dependencies are consistent between environments and across deployments.</p>

<p>Packages like <code class="language-plaintext highlighter-rouge">eslint</code> that get published to the npm registry do not include lock files. <code class="language-plaintext highlighter-rouge">npm install eslint</code> as a user will respect version constraints in ESLint’s <code class="language-plaintext highlighter-rouge">package.json</code>. ESLint and its dependencies will be included in the user’s lock file if one exists, but ESLint’s own lock file would not be used.</p>
...
<ul>
  ...
  <li>Minor release (might break your lint build)
    <ul>
      ...
      <li><code class="language-plaintext highlighter-rouge">eslint:recommended</code> is updated and will result in strictly fewer linting errors (e.g., rule removals).</li>
    </ul>
  </li>
  <li>Major release (likely to break your lint build)
    <ul>
      <li><code class="language-plaintext highlighter-rouge">eslint:recommended</code> is updated and may result in new linting errors (e.g., rule additions, most rule option updates).</li>
...
<p>According to our policy, any minor update may report more linting errors than the previous release (ex: from a bug fix). As such, we recommend using the tilde (<code class="language-plaintext highlighter-rouge">~</code>) in <code class="language-plaintext highlighter-rouge">package.json</code> e.g. <code class="language-plaintext highlighter-rouge">"eslint": "~3.1.0"</code> to guarantee the results of your builds.</p>
...
<p><a href="#"><img src="https://images.opencollective.com/2021-frameworks-fund/logo.png" alt="Chrome Frameworks Fund" height="undefined" /></a> <a href="https://automattic.com"><img src="https://images.opencollective.com/automattic/d0ef3e1/logo.png" alt="Automattic" height="undefined" /></a></p>
<h3>Gold Sponsors</h3>
<p><a href="https://engineering.salesforce.com"><img src="https://images.opencollective.com/salesforce/ca8f997/logo.png" alt="Salesforce" height="96" /></a> <a href="https://www.airbnb.com/"><img src="https://images.opencollective.com/airbnb/d327d66/logo.png" alt="Airbnb" height="96" /></a></p>
...
<h2 id="technology-sponsors">Technology Sponsors</h2>
