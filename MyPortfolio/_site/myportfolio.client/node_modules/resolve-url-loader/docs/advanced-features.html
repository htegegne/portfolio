...
<p>Jump to the <strong>“how to”</strong> section -</p>
<ul>
...
<h2 id="what-is-the-join-function">What is the “join” function?</h2>
...
<p>⚠️ <strong>IMPORTANT</strong> - First read how the <a href="/myportfolio.client/node_modules/resolve-url-loader/docs/how-it-works.html#algorithm">algorithm</a> works.</p>

<p>The “join” function is a higher-order function created using the <code class="language-plaintext highlighter-rouge">options</code> and <code class="language-plaintext highlighter-rouge">loader</code> reference. That gives a function that accepts a single <code class="language-plaintext highlighter-rouge">item</code> and synchronously returns an absolute asset path to substitute back into the original CSS.</p>
...
<p>A custom <code class="language-plaintext highlighter-rouge">join</code> function from scratch is possible but we’ve provided some <a href="#building-blocks">building blocks</a> to make the task easier.</p>

<h2 id="building-blocks">Building blocks</h2>

<p>There are a number of utilities (defined in <a href="/myportfolio.client/node_modules/resolve-url-loader/lib/join-function/index.js"><code class="language-plaintext highlighter-rouge">lib/join-function/index.js</code></a>) to help construct a custom “join” function . These are conveniently re-exported as properties of the loader.</p>
...
<p>🤓 If you have some very specific behaviour in mind you can specify your own implementation. This gives full control but still gives you <code class="language-plaintext highlighter-rouge">debug</code> logging for free.</p>
...
<p>👉 However its recommended to instead use <code class="language-plaintext highlighter-rouge">createJoinImplementation</code> to create the <code class="language-plaintext highlighter-rouge">implementation</code> using the <code class="language-plaintext highlighter-rouge">generator</code> concept.</p>
...
<p>Don’t worry, you don’t need to use <code class="language-plaintext highlighter-rouge">function*</code> semantics for the <code class="language-plaintext highlighter-rouge">generator</code> unless you want to.</p>
...
<p>Source-map sampling is limited to the locations defined in the <a href="/myportfolio.client/node_modules/resolve-url-loader/docs/how-it-works.html#algorithm">algorithm</a>. You can’t change these locations but you can preference them in a different order.</p>
...
<p>⚠️ <strong>IMPORTANT</strong> - This example is indicative only and is <strong>not</strong> advised.</p>
...
<p>It provides additional logging when using <code class="language-plaintext highlighter-rouge">debug</code> option so is a better choice then writing a “join” function from scratch.</p>
