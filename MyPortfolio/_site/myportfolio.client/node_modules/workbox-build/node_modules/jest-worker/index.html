...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/workbox-build/node_modules/jest-worker/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/workbox-build/node_modules/jest-worker/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="jest-worker" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"jest-worker","url":"http://localhost:4000/myportfolio.client/node_modules/workbox-build/node_modules/jest-worker/"}</script>
<!-- End Jekyll SEO tag -->
...
<p>The module works by providing an absolute path of the module to be loaded in all forked processes. Files relative to a node module are also accepted. All methods are exposed on the parent process as promises, so they can be <code class="language-plaintext highlighter-rouge">await</code>‘ed. Child (worker) methods can either be synchronous or asynchronous.</p>
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>yarn add jest-worker
</code></pre></div></div>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="nx">JestWorker</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">jest-worker</span><span class="dl">'</span><span class="p">;</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">export</span> <span class="kd">function</span> <span class="nx">hello</span><span class="p">(</span><span class="nx">param</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="dl">'</span><span class="s1">Hello, </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">param</span><span class="p">;</span>
<span class="p">}</span>
</code></pre></div></div>
...
<p>Since <code class="language-plaintext highlighter-rouge">worker_threads</code> are considered experimental in Node, you have to opt-in to this behavior by passing <code class="language-plaintext highlighter-rouge">enableWorkerThreads: true</code> when instantiating the worker. While the feature was unflagged in Node 11.7.0, you’ll need to run the Node process with the <code class="language-plaintext highlighter-rouge">--experimental-worker</code> flag for Node 10.</p>

<h2 id="api">API</h2>

<p>The only exposed method is a constructor (<code class="language-plaintext highlighter-rouge">JestWorker</code>) that is initialized by passing the worker path, plus an options object.</p>
...
<h4 id="forkoptions-object-optional"><code class="language-plaintext highlighter-rouge">forkOptions: Object</code> (optional)</h4>

<p>Allow customizing all options passed to <code class="language-plaintext highlighter-rouge">childProcess.fork</code>. By default, some values are set (<code class="language-plaintext highlighter-rouge">cwd</code>, <code class="language-plaintext highlighter-rouge">env</code> and <code class="language-plaintext highlighter-rouge">execArgv</code>), but you can override them and customize the rest. For a list of valid values, check <a href="https://nodejs.org/api/child_process.html#child_process_child_process_fork_modulepath_args_options">the Node documentation</a>.</p>

<h4 id="computeworkerkey-method-string-args-arrayany--string-optional"><code class="language-plaintext highlighter-rouge">computeWorkerKey: (method: string, ...args: Array&lt;any&gt;) =&gt; ?string</code> (optional)</h4>
...
<h4 id="setupargs-arraymixed-optional"><code class="language-plaintext highlighter-rouge">setupArgs: Array&lt;mixed&gt;</code> (optional)</h4>
...
<h4 id="workerpool-workerpath-string-options-workerpooloptions--workerpoolinterface-optional"><code class="language-plaintext highlighter-rouge">WorkerPool: (workerPath: string, options?: WorkerPoolOptions) =&gt; WorkerPoolInterface</code> (optional)</h4>
...
<p><code class="language-plaintext highlighter-rouge">jest-worker</code> will automatically detect if <code class="language-plaintext highlighter-rouge">worker_threads</code> are available, but will not use them unless passed <code class="language-plaintext highlighter-rouge">enableWorkerThreads: true</code>.</p>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">export</span> <span class="kd">function</span> <span class="nx">foo</span><span class="p">(</span><span class="nx">param</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="dl">'</span><span class="s1">Hello from foo: </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">param</span><span class="p">;</span>
<span class="p">}</span>
...
<span class="k">export</span> <span class="kd">function</span> <span class="nx">bar</span><span class="p">(</span><span class="nx">param</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="dl">'</span><span class="s1">Hello from bar: </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">param</span><span class="p">;</span>
<span class="p">}</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="nx">babel</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">@babel/core</span><span class="dl">'</span><span class="p">;</span>
