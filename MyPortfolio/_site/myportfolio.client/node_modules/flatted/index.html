...
<p>The only way this could work is to <code class="language-plaintext highlighter-rouge">Flatted.parse(Flatted.stringify(data))</code>, as it is also for <em>CircularJSON</em> or any other, otherwise there’s no granted data integrity.</p>
