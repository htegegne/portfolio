...
<title>4.3.1 | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="4.3.1" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/deepmerge/changelog.html" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/deepmerge/changelog.html" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="4.3.1" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"4.3.1","url":"http://localhost:4000/myportfolio.client/node_modules/deepmerge/changelog.html"}</script>
<!-- End Jekyll SEO tag -->
...
<ul>
  <li>Avoid thrown errors if the target doesn’t have <code class="language-plaintext highlighter-rouge">propertyIsEnumerable</code>.  <a href="https://github.com/TehShrike/deepmerge/pull/252">#252</a></li>
</ul>

<h1 id="422"><a href="https://github.com/TehShrike/deepmerge/releases/tag/v4.2.2">4.2.2</a></h1>

<ul>
  <li><code class="language-plaintext highlighter-rouge">isMergeableObject</code> is now only called if there are two values that could be merged.  <a href="https://github.com/TehShrike/deepmerge/commit/a34dd4d25bf5e250653540a2022bc832c7b00a19">a34dd4d2</a></li>
</ul>
...
<ul>
  <li>Rolled back #167 since <code class="language-plaintext highlighter-rouge">Object.assign</code> breaks ES5 support.  <a href="https://github.com/TehShrike/deepmerge/commit/55067352a92c65a6c44a5165f3387720aae1e192">55067352</a></li>
</ul>

<h1 id="411"><a href="https://github.com/TehShrike/deepmerge/releases/tag/v4.1.1">4.1.1</a></h1>

<ul>
  <li>The <code class="language-plaintext highlighter-rouge">options</code> argument is no longer mutated <a href="https://github.com/TehShrike/deepmerge/pull/167">#167</a></li>
</ul>

<h1 id="410"><a href="https://github.com/TehShrike/deepmerge/releases/tag/v4.1.0">4.1.0</a></h1>

<ul>
  <li><code class="language-plaintext highlighter-rouge">cloneUnlessOtherwiseSpecified</code> is now exposed to the <code class="language-plaintext highlighter-rouge">arrayMerge</code> function <a href="https://github.com/TehShrike/deepmerge/pull/165">#165</a></li>
</ul>

<h1 id="400"><a href="https://github.com/TehShrike/deepmerge/releases/tag/v4.0.0">4.0.0</a></h1>

<ul>
  <li>The <code class="language-plaintext highlighter-rouge">main</code> entry point in <code class="language-plaintext highlighter-rouge">package.json</code> is now a CommonJS module instead of a UMD module <a href="https://github.com/TehShrike/deepmerge/pull/155">#155</a></li>
</ul>
...
<ul>
  <li>feature: added the <a href="https://github.com/TehShrike/deepmerge#custommerge"><code class="language-plaintext highlighter-rouge">customMerge</code></a> option <a href="https://github.com/TehShrike/deepmerge/pull/133">#133</a></li>
</ul>

<h1 id="310"><a href="https://github.com/TehShrike/deepmerge/releases/tag/v3.1.0">3.1.0</a></h1>

<ul>
  <li>typescript typing: make the <code class="language-plaintext highlighter-rouge">all</code> function generic <a href="https://github.com/TehShrike/deepmerge/pull/129">#129</a></li>
</ul>
...
<ul>
  <li>feature: Support a custom <code class="language-plaintext highlighter-rouge">isMergeableObject</code> function <a href="https://github.com/TehShrike/deepmerge/pull/96">#96</a></li>
...
<ul>
  <li>breaking: the array merge algorithm has changed from a complicated thing to <code class="language-plaintext highlighter-rouge">target.concat(source).map(element =&gt; cloneUnlessOtherwiseSpecified(element, optionsArgument))</code></li>
  <li>breaking: The <code class="language-plaintext highlighter-rouge">clone</code> option now defaults to <code class="language-plaintext highlighter-rouge">true</code></li>
  <li>feature: <code class="language-plaintext highlighter-rouge">merge.all</code> now accepts an array of any size, even 0 or 1 elements</li>
</ul>
...
<ul>
  <li>bower support: updated <code class="language-plaintext highlighter-rouge">main</code> in bower.json</li>
</ul>
...
<ul>
  <li>api: instead of only exporting a UMD module, expose a UMD module with <code class="language-plaintext highlighter-rouge">pkg.main</code>, a CJS module with <code class="language-plaintext highlighter-rouge">pkg.browser</code>, and an ES module with <code class="language-plaintext highlighter-rouge">pkg.module</code> <a href="https://github.com/TehShrike/deepmerge/pull/62">#62</a></li>
</ul>
...
<ul>
  <li>feature: <code class="language-plaintext highlighter-rouge">merge.all</code>, a merge function that merges any number of objects: pull request <a href="https://github.com/TehShrike/deepmerge/pull/50">50</a></li>
</ul>
...
<ul>
  ...
  <li>maintenance: added tests + travis to <code class="language-plaintext highlighter-rouge">.npmignore</code>: pull request <a href="https://github.com/TehShrike/deepmerge/pull/47">47</a></li>
</ul>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">null</code>, dates, and regular expressions are now properly merged in arrays: <a href="https://github.com/TehShrike/deepmerge/pull/18">Issue 18</a>, plus commit: <a href="https://github.com/TehShrike/deepmerge/commit/ef1c6bac8350ba12a24966f0bc7da02560827586">ef1c6b</a></li>
</ul>
