...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-testing-library/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-testing-library/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="portfolio" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"portfolio","url":"http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-testing-library/"}</script>
<!-- End Jekyll SEO tag -->
...
<p><a href="https://github.com/testing-library/eslint-plugin-testing-library/actions/workflows/pipeline.yml"><img src="https://github.com/testing-library/eslint-plugin-testing-library/actions/workflows/pipeline.yml/badge.svg" alt="Build status" /></a>
<a href="https://www.npmjs.com/package/eslint-plugin-testing-library"><img src="https://img.shields.io/npm/v/eslint-plugin-testing-library" alt="Package version" /></a>
<a href="https://github.com/AriPerkkio/eslint-remote-tester/actions?query=workflow%3Aeslint-plugin-testing-library"><img src="https://img.shields.io/github/workflow/status/AriPerkkio/eslint-remote-tester/eslint-plugin-testing-library?label=eslint-remote-tester" alt="eslint-remote-tester" /></a>
<a href="https://snyk.io/advisor/npm-package/eslint-plugin-testing-library"><img src="https://snyk.io/advisor/npm-package/eslint-plugin-testing-library/badge.svg" alt="eslint-plugin-testing-library" /></a>
<a href="https://github.com/testing-library/eslint-plugin-testing-library/blob/main/license"><img src="https://img.shields.io/npm/l/eslint-plugin-testing-library" alt="MIT License" /></a>
<br />
<a href="https://github.com/semantic-release/semantic-release"><img src="https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079.svg?style=flat-square" alt="semantic-release" /></a>
<a href="http://makeapullrequest.com"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square" alt="PRs Welcome" /></a>
<a href="#contributors-"><img src="https://img.shields.io/github/all-contributors/testing-library/eslint-plugin-testing-library?color=orange&amp;style=flat-square" alt="All Contributors" /></a>
<br />
<a href="https://github.com/testing-library/eslint-plugin-testing-library/watchers"><img src="https://img.shields.io/github/watchers/testing-library/eslint-plugin-testing-library?style=social" alt="Watch on Github" /></a>
<a href="https://github.com/testing-library/eslint-plugin-testing-library/stargazers"><img src="https://img.shields.io/github/stars/testing-library/eslint-plugin-testing-library?style=social" alt="Star on Github" /></a>
<a href="https://twitter.com/intent/tweet?url=https%3a%2f%2fgithub.com%2ftesting-library%2feslint-plugin-testing-library&amp;text=check%20out%20eslint-plugin-testing-library%20by%20@belcodev"><img src="https://img.shields.io/twitter/url?style=social&amp;url=https%3A%2F%2Fgithub.com%2Ftesting-library%2Feslint-plugin-testing-library" alt="Tweet" /></a></p>

<h2 id="installation">Installation</h2>

<p>You’ll first need to install <a href="https://eslint.org">ESLint</a>:</p>

<div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm <span class="nb">install</span> <span class="nt">--save-dev</span> eslint
<span class="c"># or</span>
<span class="nv">$ </span>yarn add <span class="nt">--dev</span> eslint
</code></pre></div></div>

<p>Next, install <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code>:</p>

<div class="language-shell highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>npm <span class="nb">install</span> <span class="nt">--save-dev</span> eslint-plugin-testing-library
<span class="c"># or</span>
<span class="nv">$ </span>yarn add <span class="nt">--dev</span> eslint-plugin-testing-library
</code></pre></div></div>

<p><strong>Note:</strong> If you installed ESLint globally (using the <code class="language-plaintext highlighter-rouge">-g</code> flag) then you must also install <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> globally.</p>

<h2 id="migrating">Migrating</h2>

<p>You can find detailed guides for migrating <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> in the <a href="docs/migration-guides">migration guide docs</a>:</p>

<ul>
  <li><a href="docs/migration-guides/v4.md">Migrate guide for v4</a></li>
  <li><a href="docs/migration-guides/v5.md">Migrate guide for v5</a></li>
</ul>

<h2 id="usage">Usage</h2>

<p>Add <code class="language-plaintext highlighter-rouge">testing-library</code> to the plugins section of your <code class="language-plaintext highlighter-rouge">.eslintrc.js</code> configuration file. You can omit the <code class="language-plaintext highlighter-rouge">eslint-plugin-</code> prefix:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">plugins</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">testing-library</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<p>Then configure the rules you want to use within <code class="language-plaintext highlighter-rouge">rules</code> property of your <code class="language-plaintext highlighter-rouge">.eslintrc</code>:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">rules</span><span class="p">:</span> <span class="p">{</span>
		<span class="dl">'</span><span class="s1">testing-library/await-async-query</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span>
		<span class="dl">'</span><span class="s1">testing-library/no-await-sync-query</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">error</span><span class="dl">'</span><span class="p">,</span>
		<span class="dl">'</span><span class="s1">testing-library/no-debugging-utils</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">warn</span><span class="dl">'</span><span class="p">,</span>
		<span class="dl">'</span><span class="s1">testing-library/no-dom-import</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">off</span><span class="dl">'</span><span class="p">,</span>
	<span class="p">},</span>
<span class="p">};</span>
</code></pre></div></div>

<h3 id="run-the-plugin-only-against-test-files">Run the plugin only against test files</h3>

<p>With the default setup mentioned before, <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> will be run against your whole codebase. If you want to run this plugin only against your tests files, you have the following options:</p>

<h4 id="eslint-overrides">ESLint <code class="language-plaintext highlighter-rouge">overrides</code></h4>

<p>One way of restricting ESLint config by file patterns is by using <a href="https://eslint.org/docs/user-guide/configuring/configuration-files#configuration-based-on-glob-patterns">ESLint <code class="language-plaintext highlighter-rouge">overrides</code></a>.</p>

<p>Assuming you are using the same pattern for your test files as <a href="https://jestjs.io/docs/configuration#testmatch-arraystring">Jest by default</a>, the following config would run <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> only against your test files:</p>
...
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="c1">// 1) Here we have our usual config which applies to the whole project, so we don't put testing-library preset here.</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">airbnb</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">plugin:prettier/recommended</span><span class="dl">'</span><span class="p">],</span>

	<span class="c1">// 2) We load other plugins than eslint-plugin-testing-library globally if we want to.</span>
	<span class="na">plugins</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">react-hooks</span><span class="dl">'</span><span class="p">],</span>

	<span class="na">overrides</span><span class="p">:</span> <span class="p">[</span>
		<span class="p">{</span>
			<span class="c1">// 3) Now we enable eslint-plugin-testing-library rules or preset only for matching testing files!</span>
			<span class="na">files</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">**/__tests__/**/*.[jt]s?(x)</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">**/?(*.)+(spec|test).[jt]s?(x)</span><span class="dl">'</span><span class="p">],</span>
			<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/react</span><span class="dl">'</span><span class="p">],</span>
		<span class="p">},</span>
	<span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<h4 id="eslint-cascading-and-hierarchy">ESLint Cascading and Hierarchy</h4>

<p>Another approach for customizing ESLint config by paths is through <a href="https://eslint.org/docs/user-guide/configuring/configuration-files#cascading-and-hierarchy">ESLint Cascading and Hierarchy</a>. This is useful if all your tests are placed under the same folder, so you can place there another <code class="language-plaintext highlighter-rouge">.eslintrc</code> where you enable <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> for applying it only to the files under such folder, rather than enabling it on your global <code class="language-plaintext highlighter-rouge">.eslintrc</code> which would apply to your whole project.</p>

<h2 id="shareable-configurations">Shareable configurations</h2>

<p>This plugin exports several recommended configurations that enforce good practices for specific Testing Library packages.
You can find more info about enabled rules in the <a href="#supported-rules">Supported Rules section</a>, under the <code class="language-plaintext highlighter-rouge">Configurations</code> column.</p>

<p>Since each one of these configurations is aimed at a particular Testing Library package, they are not extendable between them, so you should use only one of them at once per <code class="language-plaintext highlighter-rouge">.eslintrc</code> file. For example, if you want to enable recommended configuration for React, you don’t need to combine it somehow with DOM one:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// ❌ Don't do this</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/dom</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">plugin:testing-library/react</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// ✅ Just do this instead</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/react</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>
...
<p>Enforces recommended rules for DOM Testing Library.</p>

<p>To enable this configuration use the <code class="language-plaintext highlighter-rouge">extends</code> property in your
<code class="language-plaintext highlighter-rouge">.eslintrc.js</code> config file:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/dom</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<h3 id="angular">Angular</h3>

<p>Enforces recommended rules for Angular Testing Library.</p>

<p>To enable this configuration use the <code class="language-plaintext highlighter-rouge">extends</code> property in your
<code class="language-plaintext highlighter-rouge">.eslintrc.js</code> config file:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/angular</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<h3 id="react">React</h3>

<p>Enforces recommended rules for React Testing Library.</p>
...
<p>Enforces recommended rules for Vue Testing Library.</p>

<p>To enable this configuration use the <code class="language-plaintext highlighter-rouge">extends</code> property in your
<code class="language-plaintext highlighter-rouge">.eslintrc.js</code> config file:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/vue</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>

<h3 id="marko">Marko</h3>

<p>Enforces recommended rules for Marko Testing Library.</p>

<p>To enable this configuration use the <code class="language-plaintext highlighter-rouge">extends</code> property in your
<code class="language-plaintext highlighter-rouge">.eslintrc.js</code> config file:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">extends</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">plugin:testing-library/marko</span><span class="dl">'</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div></div>
...
<blockquote>
  <p>Remember that all rules from this plugin are prefixed by <code class="language-plaintext highlighter-rouge">"testing-library/"</code></p>
</blockquote>

<!-- begin auto-generated rules list -->

<p>💼 Configurations enabled in.<br />
🔧 Automatically fixable by the <a href="https://eslint.org/docs/user-guide/command-line-interface#--fix"><code class="language-plaintext highlighter-rouge">--fix</code> CLI option</a>.</p>
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align: left"><a href="docs/rules/await-async-query.md">await-async-query</a></td>
      <td style="text-align: left">Enforce promises from async queries to be handled</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/await-async-utils.md">await-async-utils</a></td>
      <td style="text-align: left">Enforce promises from async utils to be awaited properly</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/await-fire-event.md">await-fire-event</a></td>
      <td style="text-align: left">Enforce promises from <code class="language-plaintext highlighter-rouge">fireEvent</code> methods to be handled</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/consistent-data-testid.md">consistent-data-testid</a></td>
      <td style="text-align: left">Ensures consistent usage of <code class="language-plaintext highlighter-rouge">data-testid</code></td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-await-sync-events.md">no-await-sync-events</a></td>
      <td style="text-align: left">Disallow unnecessary <code class="language-plaintext highlighter-rouge">await</code> for sync events</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-await-sync-query.md">no-await-sync-query</a></td>
      <td style="text-align: left">Disallow unnecessary <code class="language-plaintext highlighter-rouge">await</code> for sync queries</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-container.md">no-container</a></td>
      <td style="text-align: left">Disallow the use of <code class="language-plaintext highlighter-rouge">container</code> methods</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-debugging-utils.md">no-debugging-utils</a></td>
      <td style="text-align: left">Disallow the use of debugging utilities like <code class="language-plaintext highlighter-rouge">debug</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-dom-import.md">no-dom-import</a></td>
      <td style="text-align: left">Disallow importing from DOM Testing Library</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left">🔧</td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-global-regexp-flag-in-query.md">no-global-regexp-flag-in-query</a></td>
      <td style="text-align: left">Disallow the use of the global RegExp flag (/g) in queries</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left">🔧</td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-manual-cleanup.md">no-manual-cleanup</a></td>
      <td style="text-align: left">Disallow the use of <code class="language-plaintext highlighter-rouge">cleanup</code></td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-node-access.md">no-node-access</a></td>
      <td style="text-align: left">Disallow direct Node access</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-promise-in-fire-event.md">no-promise-in-fire-event</a></td>
      <td style="text-align: left">Disallow the use of promises passed to a <code class="language-plaintext highlighter-rouge">fireEvent</code> method</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-render-in-setup.md">no-render-in-setup</a></td>
      <td style="text-align: left">Disallow the use of <code class="language-plaintext highlighter-rouge">render</code> in testing frameworks setup functions</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-unnecessary-act.md">no-unnecessary-act</a></td>
      <td style="text-align: left">Disallow wrapping Testing Library utils or empty callbacks in <code class="language-plaintext highlighter-rouge">act</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-wait-for-empty-callback.md">no-wait-for-empty-callback</a></td>
      <td style="text-align: left">Disallow empty callbacks for <code class="language-plaintext highlighter-rouge">waitFor</code> and <code class="language-plaintext highlighter-rouge">waitForElementToBeRemoved</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-wait-for-multiple-assertions.md">no-wait-for-multiple-assertions</a></td>
      <td style="text-align: left">Disallow the use of multiple <code class="language-plaintext highlighter-rouge">expect</code> calls inside <code class="language-plaintext highlighter-rouge">waitFor</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-wait-for-side-effects.md">no-wait-for-side-effects</a></td>
      <td style="text-align: left">Disallow the use of side effects in <code class="language-plaintext highlighter-rouge">waitFor</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/no-wait-for-snapshot.md">no-wait-for-snapshot</a></td>
      <td style="text-align: left">Ensures no snapshot is generated inside of a <code class="language-plaintext highlighter-rouge">waitFor</code> call</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-explicit-assert.md">prefer-explicit-assert</a></td>
      <td style="text-align: left">Suggest using explicit assertions rather than standalone queries</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-find-by.md">prefer-find-by</a></td>
      <td style="text-align: left">Suggest using <code class="language-plaintext highlighter-rouge">find(All)By*</code> query instead of <code class="language-plaintext highlighter-rouge">waitFor</code> + <code class="language-plaintext highlighter-rouge">get(All)By*</code> to wait for elements</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left">🔧</td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-presence-queries.md">prefer-presence-queries</a></td>
      <td style="text-align: left">Ensure appropriate <code class="language-plaintext highlighter-rouge">get*</code>/<code class="language-plaintext highlighter-rouge">query*</code> queries are used with their respective matchers</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-query-by-disappearance.md">prefer-query-by-disappearance</a></td>
      <td style="text-align: left">Suggest using <code class="language-plaintext highlighter-rouge">queryBy*</code> queries when waiting for disappearance</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-query-matchers.md">prefer-query-matchers</a></td>
      <td style="text-align: left">Ensure the configured <code class="language-plaintext highlighter-rouge">get*</code>/<code class="language-plaintext highlighter-rouge">query*</code> query is used with the corresponding matchers</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-screen-queries.md">prefer-screen-queries</a></td>
      <td style="text-align: left">Suggest using <code class="language-plaintext highlighter-rouge">screen</code> while querying</td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/%F0%9F%90%99-DOM-black?style=flat-square" alt="badge-dom" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-user-event.md">prefer-user-event</a></td>
      <td style="text-align: left">Suggest using <code class="language-plaintext highlighter-rouge">userEvent</code> over <code class="language-plaintext highlighter-rouge">fireEvent</code> for simulating user interactions</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left"> </td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/prefer-wait-for.md">prefer-wait-for</a></td>
      <td style="text-align: left">Use <code class="language-plaintext highlighter-rouge">waitFor</code> instead of deprecated wait methods</td>
      <td style="text-align: left"> </td>
      <td style="text-align: left">🔧</td>
    </tr>
    <tr>
      <td style="text-align: left"><a href="docs/rules/render-result-naming-convention.md">render-result-naming-convention</a></td>
      <td style="text-align: left">Enforce a valid naming for return value from <code class="language-plaintext highlighter-rouge">render</code></td>
      <td style="text-align: left"><img src="https://img.shields.io/badge/-Angular-black?style=flat-square&amp;logo=angular&amp;logoColor=white&amp;labelColor=DD0031&amp;color=black" alt="badge-angular" /> <img src="https://img.shields.io/badge/-Marko-black?style=flat-square&amp;logo=marko&amp;logoColor=white&amp;labelColor=2596BE&amp;color=black" alt="badge-marko" /> <img src="https://img.shields.io/badge/-React-black?style=flat-square&amp;logo=react&amp;logoColor=white&amp;labelColor=61DAFB&amp;color=black" alt="badge-react" /> <img src="https://img.shields.io/badge/-Vue-black?style=flat-square&amp;logo=vue.js&amp;logoColor=white&amp;labelColor=4FC08D&amp;color=black" alt="badge-vue" /></td>
      <td style="text-align: left"> </td>
    </tr>
  </tbody>
...
<h2 id="aggressive-reporting">Aggressive Reporting</h2>

<p>In v4 this plugin introduced a new feature called “Aggressive Reporting”, which intends to detect Testing Library utils usages even if they don’t come directly from a Testing Library package (i.e. <a href="https://testing-library.com/docs/react-testing-library/setup/#custom-render">using a custom utility file to re-export everything from Testing Library</a>). You can <a href="docs/migration-guides/v4.md#aggressive-reporting">read more about this feature here</a>.</p>

<p>If you are looking to restricting or switching off this feature, please refer to the <a href="#shared-settings">Shared Settings section</a> to do so.</p>

<h2 id="shared-settings">Shared Settings</h2>

<p>There are some configuration options available that will be shared across all the plugin rules. This is achieved using <a href="https://eslint.org/docs/user-guide/configuring/configuration-files#adding-shared-settings">ESLint Shared Settings</a>. These Shared Settings are meant to be used if you need to restrict or switch off the Aggressive Reporting, which is an out of the box advanced feature to lint Testing Library usages in a simpler way for most of the users. <strong>So please before configuring any of these settings</strong>, read more about <a href="docs/migration-guides/v4.md#aggressive-reporting">the advantages of <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> Aggressive Reporting feature</a>, and <a href="docs/migration-guides/v4.md#shared-settings">how it’s affected by these settings</a>.</p>

<p>If you are sure about configuring the settings, these are the options available:</p>

<h3 id="testing-libraryutils-module"><code class="language-plaintext highlighter-rouge">testing-library/utils-module</code></h3>

<p>The name of your custom utility file from where you re-export everything from the Testing Library package, or <code class="language-plaintext highlighter-rouge">"off"</code> to switch related Aggressive Reporting mechanism off. Relates to <a href="docs/migration-guides/v4.md#imports">Aggressive Imports Reporting</a>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// .eslintrc.js</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">settings</span><span class="p">:</span> <span class="p">{</span>
		<span class="dl">'</span><span class="s1">testing-library/utils-module</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">my-custom-test-utility-file</span><span class="dl">'</span><span class="p">,</span>
	<span class="p">},</span>
<span class="p">};</span>
</code></pre></div></div>

<p><a href="docs/migration-guides/v4.md#testing-libraryutils-module">You can find more details about the <code class="language-plaintext highlighter-rouge">utils-module</code> setting here</a>.</p>

<h3 id="testing-librarycustom-renders"><code class="language-plaintext highlighter-rouge">testing-library/custom-renders</code></h3>

<p>A list of function names that are valid as Testing Library custom renders, or <code class="language-plaintext highlighter-rouge">"off"</code> to switch related Aggressive Reporting mechanism off. Relates to <a href="docs/migration-guides/v4.md#renders">Aggressive Renders Reporting</a>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// .eslintrc.js</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">settings</span><span class="p">:</span> <span class="p">{</span>
		<span class="dl">'</span><span class="s1">testing-library/custom-renders</span><span class="dl">'</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">display</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">renderWithProviders</span><span class="dl">'</span><span class="p">],</span>
	<span class="p">},</span>
<span class="p">};</span>
</code></pre></div></div>

<p><a href="docs/migration-guides/v4.md#testing-librarycustom-renders">You can find more details about the <code class="language-plaintext highlighter-rouge">custom-renders</code> setting here</a>.</p>

<h3 id="testing-librarycustom-queries"><code class="language-plaintext highlighter-rouge">testing-library/custom-queries</code></h3>

<p>A list of query names/patterns that are valid as Testing Library custom queries, or <code class="language-plaintext highlighter-rouge">"off"</code> to switch related Aggressive Reporting mechanism off. Relates to <a href="docs/migration-guides/v4.md#queries">Aggressive Reporting - Queries</a></p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// .eslintrc.js</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">settings</span><span class="p">:</span> <span class="p">{</span>
		<span class="dl">'</span><span class="s1">testing-library/custom-queries</span><span class="dl">'</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">ByIcon</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">getByComplexText</span><span class="dl">'</span><span class="p">],</span>
	<span class="p">},</span>
<span class="p">};</span>
</code></pre></div></div>

<p><a href="docs/migration-guides/v4.md#testing-librarycustom-queries">You can find more details about the <code class="language-plaintext highlighter-rouge">custom-queries</code> setting here</a>.</p>

<h3 id="switching-all-aggressive-reporting-mechanisms-off">Switching all Aggressive Reporting mechanisms off</h3>

<p>Since each Shared Setting is related to one Aggressive Reporting mechanism, and they accept <code class="language-plaintext highlighter-rouge">"off"</code> to opt out of that mechanism, you can switch the entire feature off by doing:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// .eslintrc.js</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">{</span>
	<span class="na">settings</span><span class="p">:</span> <span class="p">{</span>
		<span class="dl">'</span><span class="s1">testing-library/utils-module</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">off</span><span class="dl">'</span><span class="p">,</span>
		<span class="dl">'</span><span class="s1">testing-library/custom-renders</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">off</span><span class="dl">'</span><span class="p">,</span>
		<span class="dl">'</span><span class="s1">testing-library/custom-queries</span><span class="dl">'</span><span class="p">:</span> <span class="dl">'</span><span class="s1">off</span><span class="dl">'</span><span class="p">,</span>
	<span class="p">},</span>
<span class="p">};</span>
</code></pre></div></div>
...
<h3 id="errors-reported-in-non-testing-files">Errors reported in non-testing files</h3>

<p>If you find ESLint errors related to <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> in files other than testing, this could be caused by <a href="#aggressive-reporting">Aggressive Reporting</a>.</p>

<p>You can avoid this by:</p>

<ol>
  <li><a href="#run-the-plugin-only-against-test-files">running <code class="language-plaintext highlighter-rouge">eslint-plugin-testing-library</code> only against testing files</a></li>
  <li><a href="#shared-settings">limiting the scope of Aggressive Reporting through Shared Settings</a></li>
  <li><a href="#switching-all-aggressive-reporting-mechanisms-off">switching Aggressive Reporting feature off</a></li>
</ol>

<p>If you think the error you are getting is not related to this at all, please <a href="https://github.com/testing-library/eslint-plugin-testing-library/issues/new/choose">fill a new issue</a> with as many details as possible.</p>

<h3 id="false-positives-in-testing-files">False positives in testing files</h3>

<p>If you are getting false positive ESLint errors in your testing files, this could be caused by <a href="#aggressive-reporting">Aggressive Reporting</a>.</p>
...
<ul>
  <li><a href="/docs/semantic-versioning-policy.md">Semantic Versioning Policy</a></li>
</ul>
