...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/svgo/README.ru.html" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/svgo/README.ru.html" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="portfolio" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"portfolio","url":"http://localhost:4000/myportfolio.client/node_modules/svgo/README.ru.html"}</script>
<!-- End Jekyll SEO tag -->
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/inlineStyles.js">inlineStyles</a></td>
      <td>перенос стилей из элементов <code class="language-plaintext highlighter-rouge">&lt;style&gt;</code> в атрибуты <code class="language-plaintext highlighter-rouge">style</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>удаление <code class="language-plaintext highlighter-rouge">&lt;metadata&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/removeTitle.js">removeTitle</a></td>
      <td>удаление <code class="language-plaintext highlighter-rouge">&lt;title&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/removeDesc.js">removeDesc</a></td>
      <td>удаление <code class="language-plaintext highlighter-rouge">&lt;desc&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/removeUselessDefs.js">removeUselessDefs</a></td>
      <td>удаление элементов в <code class="language-plaintext highlighter-rouge">&lt;defs&gt;</code> без <code class="language-plaintext highlighter-rouge">id</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      ...
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>удаление атрибута <code class="language-plaintext highlighter-rouge">viewBox</code>, когда это возможно</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/cleanupEnableBackground.js">cleanupEnableBackground</a></td>
      <td>удаление или оптимизация атрибута <code class="language-plaintext highlighter-rouge">enable-background</code>, когда это возможно</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/minifyStyles.js">minifyStyles</a></td>
      <td>уменьшает содержимое элементов <code class="language-plaintext highlighter-rouge">&lt;style&gt;</code> с помощью <a href="https://github.com/css/csso">CSSO</a>.</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/convertStyleToAttrs.js">convertStyleToAttrs</a></td>
      <td>конвертирование стилей в атрибуте <code class="language-plaintext highlighter-rouge">style</code> в отдельные svg-атрибуты</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/convertColors.js">convertColors</a></td>
      <td>конвертирование цветовых значений: из <code class="language-plaintext highlighter-rouge">rgb()</code> в <code class="language-plaintext highlighter-rouge">#rrggbb</code>, из <code class="language-plaintext highlighter-rouge">#rrggbb</code> в <code class="language-plaintext highlighter-rouge">#rgb</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>округление дробных чисел до заданной точности, удаление <code class="language-plaintext highlighter-rouge">px</code> как единицы  |измерения по-умолчанию</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/cleanupListOfValues.js">cleanupListOfValues</a></td>
      <td>округление числовых значений в атрибутах со списком чисел, таких как <code class="language-plaintext highlighter-rouge">viewBox</code> |или <code class="language-plaintext highlighter-rouge">enableBackground</code></td>
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/moveElemsAttrsToGroup.js">moveElemsAttrsToGroup</a></td>
      <td>перемещение совпадающих атрибутов у всех элементов внутри группы <code class="language-plaintext highlighter-rouge">&lt;g&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>схлопывание бесполезных групп <code class="language-plaintext highlighter-rouge">&lt;g&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>конвертирование вырожденного эллипса <code class="language-plaintext highlighter-rouge">&lt;ellipse&gt;</code> в круг <code class="language-plaintext highlighter-rouge">&lt;circle&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>сортировка детей <code class="language-plaintext highlighter-rouge">&lt;defs&gt;</code> для лучшей компрессии</td>
      <td><code class="language-plaintext highlighter-rouge">включен</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>добавляет имена классов корневому элементу <code class="language-plaintext highlighter-rouge">&lt;svg&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/addAttributesToSVGElement.js">addAttributesToSVGElement</a></td>
      <td>добавляет атрибуты корневому элементу <code class="language-plaintext highlighter-rouge">&lt;svg&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>удаляет элементы <code class="language-plaintext highlighter-rouge">&lt;style&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
      <td><a href="https://github.com/svg/svgo/blob/master/plugins/removeScriptElement.js">removeScriptElement</a></td>
      <td>удаляет элементы <code class="language-plaintext highlighter-rouge">&lt;script&gt;</code></td>
      <td><code class="language-plaintext highlighter-rouge">выключено</code></td>
    </tr>
    <tr>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Запуск:
  svgo [OPTIONS] [ARGS]
...
<ul>
  ...
  <li>
    ...
    <p>из <code class="language-plaintext highlighter-rouge">.svgz</code> в <code class="language-plaintext highlighter-rouge">.svg</code>:</p>
    ...
    <p>из <code class="language-plaintext highlighter-rouge">.svg</code> в <code class="language-plaintext highlighter-rouge">.svgz</code>:</p>
