...
<title>file-entry-cache | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="file-entry-cache" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/file-entry-cache/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/file-entry-cache/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="file-entry-cache" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"file-entry-cache","url":"http://localhost:4000/myportfolio.client/node_modules/file-entry-cache/"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm i <span class="nt">--save</span> file-entry-cache
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<p>The module exposes two functions <code class="language-plaintext highlighter-rouge">create</code> and <code class="language-plaintext highlighter-rouge">createFromFile</code>.</p>

<h2 id="createcachename-directory-usechecksum"><code class="language-plaintext highlighter-rouge">create(cacheName, [directory, useCheckSum])</code></h2>
<ul>
...
<h2 id="createfromfilepathtocache-usechecksum"><code class="language-plaintext highlighter-rouge">createFromFile(pathToCache, [useCheckSum])</code></h2>
<ul>
  <li><strong>pathToCache</strong>: the path to the cache file (this combines the cache name and directory)</li>
  <li><strong>useCheckSum</strong>: Whether to use md5 checksum to verify if file changed. If false the default will be to use the mtime and size of the file.</li>
</ul>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// loads the cache, if one does not exists for the given</span>
...
a script that will beautify files with <code class="language-plaintext highlighter-rouge">esformatter</code> to execute only on the files that were changed since the last run.</p>

<p>In doing so the process of beautifying files was reduced from several seconds to a small fraction of a second.</p>

<p>This module uses <a href="https://www.npmjs.com/package/flat-cache">flat-cache</a> a super simple <code class="language-plaintext highlighter-rouge">key/value</code> cache storage with
...
then store the new state of the files. The next time this module request for <code class="language-plaintext highlighter-rouge">getChangedFiles</code> will return only
...
transform could be stored in the <code class="language-plaintext highlighter-rouge">meta</code> field, of the entries. Anything added to the meta field will be persisted.
Those processes won’t need to call <code class="language-plaintext highlighter-rouge">getChangedFiles</code> they will instead call <code class="language-plaintext highlighter-rouge">normalizeEntries</code> that will return the
entries with a <code class="language-plaintext highlighter-rouge">changed</code> field that can be used to determine if the file was changed or not. If it was not changed
