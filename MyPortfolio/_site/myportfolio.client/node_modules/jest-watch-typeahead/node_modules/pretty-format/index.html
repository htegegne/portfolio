...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/pretty-format/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/pretty-format/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="pretty-format" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"pretty-format","url":"http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/pretty-format/"}</script>
<!-- End Jekyll SEO tag -->
...
| <code class="language-plaintext highlighter-rouge">maxWidth</code>            | <code class="language-plaintext highlighter-rouge">number</code>  | <code class="language-plaintext highlighter-rouge">Infinity</code> | number of elements to print in arrays, sets, and so on  |
...
| <code class="language-plaintext highlighter-rouge">spacingInner</code>      | <code class="language-plaintext highlighter-rouge">string</code>  | spacing to separate items in a list                     |
| <code class="language-plaintext highlighter-rouge">spacingOuter</code>      | <code class="language-plaintext highlighter-rouge">string</code>  | spacing to enclose a list of items                      |</p>
...
<span class="kd">const</span> <span class="nx">plugin</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="nx">serialize</span><span class="p">(</span><span class="nx">array</span><span class="p">,</span> <span class="nx">config</span><span class="p">,</span> <span class="nx">indentation</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">refs</span><span class="p">,</span> <span class="nx">printer</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">return</span> <span class="o">++</span><span class="nx">depth</span> <span class="o">&gt;</span> <span class="nx">config</span><span class="p">.</span><span class="nx">maxDepth</span>
      <span class="p">?</span> <span class="s2">`[</span><span class="p">${</span><span class="nx">name</span><span class="p">}</span><span class="s2">]`</span>
      <span class="p">:</span> <span class="s2">`</span><span class="p">${</span><span class="nx">config</span><span class="p">.</span><span class="nx">min</span> <span class="p">?</span> <span class="dl">''</span> <span class="p">:</span> <span class="s2">`</span><span class="p">${</span><span class="nx">name</span><span class="p">}</span><span class="s2"> `</span><span class="p">}</span><span class="s2">[</span><span class="p">${</span><span class="nx">serializeItems</span><span class="p">(</span>
