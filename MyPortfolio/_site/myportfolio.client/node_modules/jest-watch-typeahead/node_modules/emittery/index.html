...
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/emittery/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/emittery/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="portfolio" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"portfolio","url":"http://localhost:4000/myportfolio.client/node_modules/jest-watch-typeahead/node_modules/emittery/"}</script>
<!-- End Jekyll SEO tag -->
...
<p><a href="https://codecov.io/gh/sindresorhus/emittery"><img src="https://codecov.io/gh/sindresorhus/emittery/branch/main/graph/badge.svg" alt="Coverage Status" /></a>
...
<p>Default: <code class="language-plaintext highlighter-rouge">true</code> if the <code class="language-plaintext highlighter-rouge">DEBUG</code> environment variable is set to <code class="language-plaintext highlighter-rouge">emittery</code> or <code class="language-plaintext highlighter-rouge">*</code>, otherwise <code class="language-plaintext highlighter-rouge">false</code>.</p>

<p>Example:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">Emittery</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">emittery</span><span class="dl">'</span><span class="p">);</span>

<span class="nx">Emittery</span><span class="p">.</span><span class="nx">isDebugEnabled</span> <span class="o">=</span> <span class="kc">true</span><span class="p">;</span>

<span class="kd">const</span> <span class="nx">emitter1</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span><span class="na">debug</span><span class="p">:</span> <span class="p">{</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">myEmitter1</span><span class="dl">'</span><span class="p">}});</span>
<span class="kd">const</span> <span class="nx">emitter2</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span><span class="na">debug</span><span class="p">:</span> <span class="p">{</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">myEmitter2</span><span class="dl">'</span><span class="p">}});</span>

<span class="nx">emitter1</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="c1">// …</span>
<span class="p">});</span>

<span class="nx">emitter2</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">otherTest</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="c1">// …</span>
<span class="p">});</span>

<span class="nx">emitter1</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">//=&gt; [16:43:20.417][emittery:subscribe][myEmitter1] Event Name: test</span>
<span class="c1">//	data: undefined</span>

<span class="nx">emitter2</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">otherTest</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">const</span> <span class="nx">emitter</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span><span class="na">debug</span><span class="p">:</span> <span class="p">{</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">myEmitter</span><span class="dl">'</span><span class="p">}});</span>

<span class="nx">emitter</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="c1">// …</span>
<span class="p">});</span>

<span class="nx">emitter</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">const</span> <span class="nx">emitter1</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span><span class="na">debug</span><span class="p">:</span> <span class="p">{</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">emitter1</span><span class="dl">'</span><span class="p">,</span> <span class="na">enabled</span><span class="p">:</span> <span class="kc">true</span><span class="p">}});</span>
<span class="kd">const</span> <span class="nx">emitter2</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span><span class="na">debug</span><span class="p">:</span> <span class="p">{</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">emitter2</span><span class="dl">'</span><span class="p">}});</span>

<span class="nx">emitter1</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="c1">// …</span>
<span class="p">});</span>

<span class="nx">emitter2</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="nx">data</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="c1">// …</span>
<span class="p">});</span>
...
<span class="nx">emitter2</span><span class="p">.</span><span class="nx">emit</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">);</span>
</code></pre></div></div>

<h6 id="logger">logger?</h6>

<p>Type: <code class="language-plaintext highlighter-rouge">Function(string, string, EventName?, Record&lt;string, any&gt;?) =&gt; void</code></p>

<p>Default:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="p">(</span><span class="nx">type</span><span class="p">,</span> <span class="nx">debugName</span><span class="p">,</span> <span class="nx">eventName</span><span class="p">,</span> <span class="nx">eventData</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
	<span class="k">if</span> <span class="p">(</span><span class="k">typeof</span> <span class="nx">eventData</span> <span class="o">===</span> <span class="dl">'</span><span class="s1">object</span><span class="dl">'</span><span class="p">)</span> <span class="p">{</span>
		<span class="nx">eventData</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span><span class="nx">eventData</span><span class="p">);</span>
	<span class="p">}</span>

	<span class="k">if</span> <span class="p">(</span><span class="k">typeof</span> <span class="nx">eventName</span> <span class="o">===</span> <span class="dl">'</span><span class="s1">symbol</span><span class="dl">'</span><span class="p">)</span> <span class="p">{</span>
		<span class="nx">eventName</span> <span class="o">=</span> <span class="nx">eventName</span><span class="p">.</span><span class="nx">toString</span><span class="p">();</span>
	<span class="p">}</span>

	<span class="kd">const</span> <span class="nx">currentTime</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Date</span><span class="p">();</span>
	<span class="kd">const</span> <span class="nx">logTime</span> <span class="o">=</span> <span class="s2">`</span><span class="p">${</span><span class="nx">currentTime</span><span class="p">.</span><span class="nx">getHours</span><span class="p">()}</span><span class="s2">:</span><span class="p">${</span><span class="nx">currentTime</span><span class="p">.</span><span class="nx">getMinutes</span><span class="p">()}</span><span class="s2">:</span><span class="p">${</span><span class="nx">currentTime</span><span class="p">.</span><span class="nx">getSeconds</span><span class="p">()}</span><span class="s2">.</span><span class="p">${</span><span class="nx">currentTime</span><span class="p">.</span><span class="nx">getMilliseconds</span><span class="p">()}</span><span class="s2">`</span><span class="p">;</span>
	<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">`[</span><span class="p">${</span><span class="nx">logTime</span><span class="p">}</span><span class="s2">][emittery:</span><span class="p">${</span><span class="nx">type</span><span class="p">}</span><span class="s2">][</span><span class="p">${</span><span class="nx">debugName</span><span class="p">}</span><span class="s2">] Event Name: </span><span class="p">${</span><span class="nx">eventName</span><span class="p">}</span><span class="s2">\n\tdata: </span><span class="p">${</span><span class="nx">eventData</span><span class="p">}</span><span class="s2">`</span><span class="p">);</span>
<span class="p">}</span>
</code></pre></div></div>
...
<span class="kd">const</span> <span class="nx">myLogger</span> <span class="o">=</span> <span class="p">(</span><span class="nx">type</span><span class="p">,</span> <span class="nx">debugName</span><span class="p">,</span> <span class="nx">eventName</span><span class="p">,</span> <span class="nx">eventData</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">`[</span><span class="p">${</span><span class="nx">type</span><span class="p">}</span><span class="s2">]: </span><span class="p">${</span><span class="nx">eventName</span><span class="p">}</span><span class="s2">`</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">emitter</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Emittery</span><span class="p">({</span>
	<span class="na">debug</span><span class="p">:</span> <span class="p">{</span>
		<span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">myEmitter</span><span class="dl">'</span><span class="p">,</span>
		<span class="na">enabled</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
		<span class="na">logger</span><span class="p">:</span> <span class="nx">myLogger</span>
	<span class="p">}</span>
<span class="p">});</span>
...
<p>To enable this feature set the DEBUG environment variable to ‘emittery’ or ‘*’. Additionally you can set the static <code class="language-plaintext highlighter-rouge">isDebugEnabled</code> variable to true on the Emittery class, or <code class="language-plaintext highlighter-rouge">myEmitter.debug.enabled</code> on an instance of it for debugging a single instance.</p>
