...
<title>Forge | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="Forge" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/node-forge/" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/node-forge/" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="Forge" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"Forge","url":"http://localhost:4000/myportfolio.client/node_modules/node-forge/"}</script>
<!-- End Jekyll SEO tag -->
...
<p><a href="https://github.com/digitalbazaar/forge/actions?query=workflow%3A%22Main+Checks%22"><img src="https://github.com/digitalbazaar/forge/workflows/Main%20Checks/badge.svg" alt="Build Status" /></a></p>

<p>A native implementation of <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> (and various other cryptographic tools) in
<a href="https://en.wikipedia.org/wiki/JavaScript">JavaScript</a>.</p>

<h2 id="introduction">Introduction</h2>

<p>The Forge software is a fully native implementation of the <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> protocol
...
<p>If you want to use forge with <a href="https://nodejs.org/">Node.js</a>, it is available through <code class="language-plaintext highlighter-rouge">npm</code>:</p>

<p>https://www.npmjs.com/package/node-forge</p>

<p>Installation:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install node-forge
</code></pre></div></div>

<p>You can then use forge as a regular module:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">forge</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">node-forge</span><span class="dl">'</span><span class="p">);</span>
</code></pre></div></div>

<p>The npm package includes pre-built <code class="language-plaintext highlighter-rouge">forge.min.js</code>, <code class="language-plaintext highlighter-rouge">forge.all.min.js</code>, and
<code class="language-plaintext highlighter-rouge">prime.worker.min.js</code> using the <a href="https://github.com/umdjs/umd">UMD</a> format.</p>
...
<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"https://cdn.jsdelivr.net/npm/node-forge@1.0.0/dist/forge.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>
...
<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"https://unpkg.com/node-forge@1.0.0/dist/forge.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>
...
<a href="/myportfolio.client/node_modules/node-forge/flash/">Flash README</a> for details.</p>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>dist/forge.js
dist/forge.min.js
</code></pre></div></div>

<p>A bundle that adds some utilities and networking support is also available:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>dist/forge.all.js
...
<code class="language-plaintext highlighter-rouge">dist/prime.worker.js</code>), so these will need to be accessible from the browser
...
<p><a href="http://browserify.org/">Browserify</a> override support is also present in <code class="language-plaintext highlighter-rouge">package.json</code>.</p>
...
<p>Forge natively runs in a <a href="https://nodejs.org/">Node.js</a> environment:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm test
</code></pre></div></div>

<h3 id="running-automated-tests-with-headless-chrome">Running automated tests with Headless Chrome</h3>

<p>Automated testing is done via <a href="https://karma-runner.github.io/">Karma</a>. By default it will run the tests with
Headless Chrome.</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma
</code></pre></div></div>

<p>Is ‘mocha’ reporter output too verbose? Other reporters are available. Try
‘dots’, ‘progress’, or ‘tap’.</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma -- --reporters progress
</code></pre></div></div>

<p>By default <a href="https://webpack.github.io/">webpack</a> is used. <a href="http://browserify.org/">Browserify</a> can also be used.</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>BUNDLER=browserify npm run test-karma
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-karma -- --browsers Chrome,Firefox,Safari,ChromeHeadless
</code></pre></div></div>

<p>The reporter option and <code class="language-plaintext highlighter-rouge">BUNDLER</code> environment variable can also be used.</p>
...
used by running <code class="language-plaintext highlighter-rouge">node tests/server.js</code> manually.</p>

<p>To run the unit tests in a browser a special forge build is required:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-build
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm run test-server
</code></pre></div></div>
...
will be put in the <code class="language-plaintext highlighter-rouge">coverage/</code> directory. Note that coverage testing can slow
...
may set the <code class="language-plaintext highlighter-rouge">forge.options.usePureJavaScript</code> flag to <code class="language-plaintext highlighter-rouge">true</code>. It is
...
<span class="kd">var</span> <span class="nx">client</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  ...
  <span class="na">virtualHost</span><span class="p">:</span> <span class="dl">'</span><span class="s1">example.com</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">verify</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">verified</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">certs</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">if</span><span class="p">(</span><span class="nx">depth</span> <span class="o">===</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
      <span class="kd">var</span> <span class="nx">cn</span> <span class="o">=</span> <span class="nx">certs</span><span class="p">[</span><span class="mi">0</span><span class="p">].</span><span class="nx">subject</span><span class="p">.</span><span class="nx">getField</span><span class="p">(</span><span class="dl">'</span><span class="s1">CN</span><span class="dl">'</span><span class="p">).</span><span class="nx">value</span><span class="p">;</span>
      <span class="k">if</span><span class="p">(</span><span class="nx">cn</span> <span class="o">!==</span> <span class="dl">'</span><span class="s1">example.com</span><span class="dl">'</span><span class="p">)</span> <span class="p">{</span>
        <span class="nx">verified</span> <span class="o">=</span> <span class="p">{</span>
          ...
          <span class="na">message</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Certificate common name does not match hostname.</span><span class="dl">'</span>
        <span class="p">};</span>
      <span class="p">}</span>
    <span class="p">}</span>
  ...
  <span class="na">connected</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">connection</span><span class="p">.</span><span class="nx">prepare</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">encodeUtf8</span><span class="p">(</span><span class="dl">'</span><span class="s1">Hi server!</span><span class="dl">'</span><span class="p">));</span>
  ...
  <span class="na">dataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">the server sent: </span><span class="dl">'</span> <span class="o">+</span>
...
<span class="kd">var</span> <span class="nx">server</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  ...
  <span class="na">verify</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">verified</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">certs</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">if</span><span class="p">(</span><span class="nx">depth</span> <span class="o">===</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
      <span class="kd">var</span> <span class="nx">cn</span> <span class="o">=</span> <span class="nx">certs</span><span class="p">[</span><span class="mi">0</span><span class="p">].</span><span class="nx">subject</span><span class="p">.</span><span class="nx">getField</span><span class="p">(</span><span class="dl">'</span><span class="s1">CN</span><span class="dl">'</span><span class="p">).</span><span class="nx">value</span><span class="p">;</span>
      <span class="k">if</span><span class="p">(</span><span class="nx">cn</span> <span class="o">!==</span> <span class="dl">'</span><span class="s1">the-client</span><span class="dl">'</span><span class="p">)</span> <span class="p">{</span>
        <span class="nx">verified</span> <span class="o">=</span> <span class="p">{</span>
          <span class="na">alert</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">Alert</span><span class="p">.</span><span class="nx">Description</span><span class="p">.</span><span class="nx">bad_certificate</span><span class="p">,</span>
          <span class="na">message</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Certificate common name does not match expected client.</span><span class="dl">'</span>
        <span class="p">};</span>
      <span class="p">}</span>
    <span class="p">}</span>
    <span class="k">return</span> <span class="nx">verified</span><span class="p">;</span>
  ...
  <span class="na">connected</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">connection</span><span class="p">.</span><span class="nx">prepare</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">encodeUtf8</span><span class="p">(</span><span class="dl">'</span><span class="s1">Hi client!</span><span class="dl">'</span><span class="p">));</span>
    <span class="cm">/* NOTE: experimental, start heartbeat retransmission timer
    myHeartbeatTimer = setInterval(function() {
      connection.prepareHeartbeatRequest(forge.util.createBuffer('1234'));
    }, 5*60*1000);*/</span>
  ...
  <span class="na">dataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">the client sent: </span><span class="dl">'</span> <span class="o">+</span>
      <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">decodeUtf8</span><span class="p">(</span><span class="nx">connection</span><span class="p">.</span><span class="nx">data</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">()));</span>
    <span class="c1">// close connection</span>
    <span class="nx">connection</span><span class="p">.</span><span class="nx">close</span><span class="p">();</span>
  <span class="p">},</span>
...
<span class="kd">var</span> <span class="nx">client</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">tls</span><span class="p">.</span><span class="nx">createConnection</span><span class="p">({</span>
  ...
  <span class="na">verify</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">verified</span><span class="p">,</span> <span class="nx">depth</span><span class="p">,</span> <span class="nx">certs</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[tls] server certificate verified</span><span class="dl">'</span><span class="p">);</span>
    <span class="k">return</span> <span class="kc">true</span><span class="p">;</span>
  <span class="p">},</span>
  <span class="na">connected</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[tls] connected</span><span class="dl">'</span><span class="p">);</span>
    ...
    <span class="nx">client</span><span class="p">.</span><span class="nx">prepare</span><span class="p">(</span><span class="dl">'</span><span class="s1">GET / HTTP/1.0</span><span class="se">\r\n\r\n</span><span class="dl">'</span><span class="p">);</span>
  <span class="p">},</span>
  <span class="na">tlsDataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">socket</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// encoding should be 'binary'</span>
  <span class="p">},</span>
  <span class="na">dataReady</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">)</span> <span class="p">{</span>
    <span class="c1">// clear data from the server is ready</span>
    ...
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[tls] data received from the server: </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">data</span><span class="p">);</span>
  <span class="p">},</span>
  <span class="na">closed</span><span class="p">:</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[tls] disconnected</span><span class="dl">'</span><span class="p">);</span>
  <span class="p">},</span>
  <span class="na">error</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">connection</span><span class="p">,</span> <span class="nx">error</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[tls] error</span><span class="dl">'</span><span class="p">,</span> <span class="nx">error</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">});</span>
...
<span class="nx">socket</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">connect</span><span class="dl">'</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[socket] connected</span><span class="dl">'</span><span class="p">);</span>
  <span class="nx">client</span><span class="p">.</span><span class="nx">handshake</span><span class="p">();</span>
<span class="p">});</span>
<span class="nx">socket</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">data</span><span class="dl">'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">client</span><span class="p">.</span><span class="nx">process</span><span class="p">(</span><span class="nx">data</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">));</span> <span class="c1">// encoding should be 'binary'</span>
<span class="p">});</span>
<span class="nx">socket</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="dl">'</span><span class="s1">end</span><span class="dl">'</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">[socket] disconnected</span><span class="dl">'</span><span class="p">);</span>
<span class="p">});</span>

<span class="c1">// connect to google.com</span>
<span class="nx">socket</span><span class="p">.</span><span class="nx">connect</span><span class="p">(</span><span class="mi">443</span><span class="p">,</span> <span class="dl">'</span><span class="s1">google.com</span><span class="dl">'</span><span class="p">);</span>
...
<p>Provides a native <a href="https://en.wikipedia.org/wiki/JavaScript">JavaScript</a> mini-implementation of an http client that
...
<span class="kd">var</span> <span class="nx">request</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">http</span><span class="p">.</span><span class="nx">createRequest</span><span class="p">({</span><span class="na">method</span><span class="p">:</span> <span class="dl">'</span><span class="s1">GET</span><span class="dl">'</span><span class="p">,</span> <span class="na">path</span><span class="p">:</span> <span class="nx">url</span><span class="p">.</span><span class="nx">path</span><span class="p">});</span>
  ...
  <span class="k">if</span><span class="p">(</span><span class="o">!</span><span class="nx">response</span><span class="p">.</span><span class="nx">bodyReceived</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">if</span><span class="p">(</span><span class="o">!</span><span class="nx">response</span><span class="p">.</span><span class="nx">headerReceived</span><span class="p">)</span> <span class="p">{</span>
      <span class="k">if</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">readHeader</span><span class="p">(</span><span class="nx">buffer</span><span class="p">))</span> <span class="p">{</span>
        <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">HTTP response header: </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">response</span><span class="p">.</span><span class="nx">toString</span><span class="p">());</span>
      <span class="p">}</span>
    <span class="p">}</span>
    <span class="k">if</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">headerReceived</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="nx">response</span><span class="p">.</span><span class="nx">bodyReceived</span><span class="p">)</span> <span class="p">{</span>
      <span class="k">if</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">readBody</span><span class="p">(</span><span class="nx">buffer</span><span class="p">))</span> <span class="p">{</span>
        <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">HTTP response body: </span><span class="dl">'</span> <span class="o">+</span> <span class="nx">response</span><span class="p">.</span><span class="nx">body</span><span class="p">);</span>
      <span class="p">}</span>
    <span class="p">}</span>
  <span class="p">}</span>
<span class="p">};</span>
...
<span class="nx">forge</span><span class="p">.</span><span class="nx">ssh</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">hex</span><span class="dl">'</span><span class="p">,</span> <span class="na">delimiter</span><span class="p">:</span> <span class="dl">'</span><span class="s1">:</span><span class="dl">'</span><span class="p">});</span>
</code></pre></div></div>
...
<p>When using an <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a> algorithm, the key size will determine whether
AES-128, AES-192, or AES-256 is used (all are supported). When a <a href="https://en.wikipedia.org/wiki/Data_Encryption_Standard">DES</a>
algorithm is used, the key size will determine whether <a href="https://en.wikipedia.org/wiki/Triple_DES">3DES</a> or regular
<a href="https://en.wikipedia.org/wiki/Data_Encryption_Standard">DES</a> is used. Use a <a href="https://en.wikipedia.org/wiki/Triple_DES">3DES</a> algorithm to enforce Triple-DES.</p>
...
<span class="kd">var</span> <span class="nx">cipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createCipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">AES-CBC</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">decipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createDecipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">AES-CBC</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">decrypted</span> <span class="o">=</span> <span class="dl">''</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">cipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createCipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">AES-GCM</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span>
  ...
  <span class="na">additionalData</span><span class="p">:</span> <span class="dl">'</span><span class="s1">binary-encoded string</span><span class="dl">'</span><span class="p">,</span> <span class="c1">// optional</span>
...
<span class="kd">var</span> <span class="nx">decipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createDecipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">AES-GCM</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
...
<span class="kd">function</span> <span class="nx">encrypt</span><span class="p">(</span><span class="nx">password</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="dl">'</span><span class="s1">input.txt</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">});</span>
  ...
  <span class="kd">var</span> <span class="nx">cipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createCipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">3DES-CBC</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
  <span class="nx">cipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span><span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">});</span>
  <span class="nx">cipher</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">));</span>
  <span class="nx">cipher</span><span class="p">.</span><span class="nx">finish</span><span class="p">();</span>
  ...
  <span class="k">if</span><span class="p">(</span><span class="nx">salt</span> <span class="o">!==</span> <span class="kc">null</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">output</span><span class="p">.</span><span class="nx">putBytes</span><span class="p">(</span><span class="dl">'</span><span class="s1">Salted__</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// (add to match openssl tool output)</span>
  ...
  <span class="nx">fs</span><span class="p">.</span><span class="nx">writeFileSync</span><span class="p">(</span><span class="dl">'</span><span class="s1">input.enc</span><span class="dl">'</span><span class="p">,</span> <span class="nx">output</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(),</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">});</span>
<span class="p">}</span>
...
<span class="kd">function</span> <span class="nx">decrypt</span><span class="p">(</span><span class="nx">password</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="dl">'</span><span class="s1">input.enc</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">});</span>

  <span class="c1">// parse salt from input</span>
  <span class="nx">input</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">);</span>
  <span class="c1">// skip "Salted__" (if known to be present)</span>
  <span class="nx">input</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(</span><span class="dl">'</span><span class="s1">Salted__</span><span class="dl">'</span><span class="p">.</span><span class="nx">length</span><span class="p">);</span>
  ...
  <span class="kd">var</span> <span class="nx">decipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createDecipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">3DES-CBC</span><span class="dl">'</span><span class="p">,</span> <span class="nx">key</span><span class="p">);</span>
  <span class="nx">decipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span><span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">});</span>
  ...
  <span class="nx">fs</span><span class="p">.</span><span class="nx">writeFileSync</span><span class="p">(</span>
    <span class="dl">'</span><span class="s1">input.dec.txt</span><span class="dl">'</span><span class="p">,</span> <span class="nx">decipher</span><span class="p">.</span><span class="nx">output</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(),</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">});</span>
<span class="p">}</span>
</code></pre></div></div>
...
<a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CTR</a>, and <a href="https://en.wikipedia.org/wiki/GCM_mode">GCM</a> modes. See <a href="#cipher">CIPHER</a> for examples.</p>

<p><a name="des"></a></p>

<h3 id="des">DES</h3>

<p>Provides <a href="https://en.wikipedia.org/wiki/Triple_DES">3DES</a> and <a href="https://en.wikipedia.org/wiki/Data_Encryption_Standard">DES</a> encryption and decryption in <a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">ECB</a> and
<a href="https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation">CBC</a> modes. See <a href="#cipher">CIPHER</a> for examples.</p>
...
<p>Provides <a href="https://en.wikipedia.org/wiki/X.509">X.509</a> certificate support, ED25519 key generation and
signing/verifying, and RSA public and private key encoding, decoding,
encryption/decryption, and signing/verifying.</p>

<p><a name="ed25519"></a></p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">ed25519</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">ed25519</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">keypair</span> <span class="o">=</span> <span class="nx">ed25519</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">({</span><span class="na">seed</span><span class="p">:</span> <span class="nx">seed</span><span class="p">});</span>

<span class="c1">// generate a random ED25519 keypair based on a "password" 32-byte seed</span>
<span class="kd">var</span> <span class="nx">password</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">Mai9ohgh6ahxee0jutheew0pungoozil</span><span class="dl">'</span><span class="p">;</span>
<span class="kd">var</span> <span class="nx">seed</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">ByteBuffer</span><span class="p">(</span><span class="nx">password</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">keypair</span> <span class="o">=</span> <span class="nx">ed25519</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">({</span><span class="na">seed</span><span class="p">:</span> <span class="nx">seed</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">signature</span> <span class="o">=</span> <span class="nx">ED25519</span><span class="p">.</span><span class="nx">sign</span><span class="p">({</span>
  <span class="na">message</span><span class="p">:</span> <span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span>
  ...
  <span class="na">privateKey</span><span class="p">:</span> <span class="nx">privateKey</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">signature</span> <span class="o">=</span> <span class="nx">ED25519</span><span class="p">.</span><span class="nx">sign</span><span class="p">({</span>
  ...
  <span class="na">message</span><span class="p">:</span> <span class="nx">Buffer</span><span class="p">.</span><span class="k">from</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">),</span>
  <span class="na">privateKey</span><span class="p">:</span> <span class="nx">privateKey</span>
<span class="p">});</span>
...
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">signature</span> <span class="o">=</span> <span class="nx">ED25519</span><span class="p">.</span><span class="nx">sign</span><span class="p">({</span>
  <span class="na">md</span><span class="p">:</span> <span class="nx">md</span><span class="p">,</span>
  <span class="na">privateKey</span><span class="p">:</span> <span class="nx">privateKey</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">verified</span> <span class="o">=</span> <span class="nx">ED25519</span><span class="p">.</span><span class="nx">verify</span><span class="p">({</span>
  ...
  <span class="c1">// node.js Buffer, Uint8Array, forge ByteBuffer, or binary string</span>
  <span class="na">publicKey</span><span class="p">:</span> <span class="nx">publicKey</span>
<span class="p">});</span>
...
<span class="c1">// *NOT RECOMMENDED*: Can be significantly slower than async and may block</span>
<span class="c1">// JavaScript execution. Will use native Node.js 10.12.0+ API if possible.</span>
...
<span class="c1">// *RECOMMENDED*: Can be significantly faster than sync. Will use native</span>
<span class="c1">// Node.js 10.12.0+ or WebCrypto API if possible.</span>
...
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="dl">'</span><span class="s1">sign this</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">encrypted</span> <span class="o">=</span> <span class="nx">publicKey</span><span class="p">.</span><span class="nx">encrypt</span><span class="p">(</span><span class="nx">bytes</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSAES-PKCS1-V1_5</span><span class="dl">'</span><span class="p">);</span>

<span class="c1">// decrypt data with a private key using RSAES PKCS#1 v1.5</span>
<span class="kd">var</span> <span class="nx">decrypted</span> <span class="o">=</span> <span class="nx">privateKey</span><span class="p">.</span><span class="nx">decrypt</span><span class="p">(</span><span class="nx">encrypted</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSAES-PKCS1-V1_5</span><span class="dl">'</span><span class="p">);</span>

<span class="c1">// encrypt data with a public key using RSAES-OAEP</span>
<span class="kd">var</span> <span class="nx">encrypted</span> <span class="o">=</span> <span class="nx">publicKey</span><span class="p">.</span><span class="nx">encrypt</span><span class="p">(</span><span class="nx">bytes</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSA-OAEP</span><span class="dl">'</span><span class="p">);</span>

<span class="c1">// decrypt data with a private key using RSAES-OAEP</span>
<span class="kd">var</span> <span class="nx">decrypted</span> <span class="o">=</span> <span class="nx">privateKey</span><span class="p">.</span><span class="nx">decrypt</span><span class="p">(</span><span class="nx">encrypted</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSA-OAEP</span><span class="dl">'</span><span class="p">);</span>

<span class="c1">// encrypt data with a public key using RSAES-OAEP/SHA-256</span>
<span class="kd">var</span> <span class="nx">encrypted</span> <span class="o">=</span> <span class="nx">publicKey</span><span class="p">.</span><span class="nx">encrypt</span><span class="p">(</span><span class="nx">bytes</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSA-OAEP</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span>
...
<span class="kd">var</span> <span class="nx">decrypted</span> <span class="o">=</span> <span class="nx">privateKey</span><span class="p">.</span><span class="nx">decrypt</span><span class="p">(</span><span class="nx">encrypted</span><span class="p">,</span> <span class="dl">'</span><span class="s1">RSA-OAEP</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span>
  <span class="na">md</span><span class="p">:</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">md</span><span class="p">.</span><span class="nx">sha256</span><span class="p">.</span><span class="nx">create</span><span class="p">()</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">someBytes</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">hello world!</span><span class="dl">'</span><span class="p">;</span>
<span class="kd">var</span> <span class="nx">cipher</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">cipher</span><span class="p">.</span><span class="nx">createCipher</span><span class="p">(</span><span class="dl">'</span><span class="s1">AES-GCM</span><span class="dl">'</span><span class="p">,</span> <span class="nx">result</span><span class="p">.</span><span class="nx">key</span><span class="p">);</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">start</span><span class="p">({</span><span class="na">iv</span><span class="p">:</span> <span class="nx">iv</span><span class="p">});</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">someBytes</span><span class="p">));</span>
<span class="nx">cipher</span><span class="p">.</span><span class="nx">finish</span><span class="p">();</span>
...
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo</span><span class="dl">'</span><span class="p">});</span>

<span class="c1">// gets a hex-encoded, colon-delimited SHA-1 RSAPublicKey public key fingerprint</span>
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span><span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">hex</span><span class="dl">'</span><span class="p">,</span> <span class="na">delimiter</span><span class="p">:</span> <span class="dl">'</span><span class="s1">:</span><span class="dl">'</span><span class="p">});</span>
...
<span class="nx">pki</span><span class="p">.</span><span class="nx">getPublicKeyFingerprint</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span> <span class="p">{</span>
  <span class="na">type</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">encoding</span><span class="p">:</span> <span class="dl">'</span><span class="s1">hex</span><span class="dl">'</span><span class="p">,</span>
...
<span class="nx">cert</span><span class="p">.</span><span class="nx">serialNumber</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">01</span><span class="dl">'</span><span class="p">;</span>
...
<span class="kd">var</span> <span class="nx">attrs</span> <span class="o">=</span> <span class="p">[{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">commonName</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">example.org</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">countryName</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">US</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  ...
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Virginia</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">localityName</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Blacksburg</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">organizationName</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Test</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">shortName</span><span class="p">:</span> <span class="dl">'</span><span class="s1">OU</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Test</span><span class="dl">'</span>
<span class="p">}];</span>
...
<span class="p">},</span> <span class="p">{</span>
  ...
  <span class="na">altNames</span><span class="p">:</span> <span class="p">[{</span>
    ...
    <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">http://example.org/webid#me</span><span class="dl">'</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="na">type</span><span class="p">:</span> <span class="mi">7</span><span class="p">,</span> <span class="c1">// IP</span>
    <span class="na">ip</span><span class="p">:</span> <span class="dl">'</span><span class="s1">127.0.0.1</span><span class="dl">'</span>
  <span class="p">}]</span>
<span class="p">},</span> <span class="p">{</span>
...
<span class="kd">var</span> <span class="nx">derivedKey</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs5</span><span class="p">.</span><span class="nx">pbkdf2</span><span class="p">(</span><span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">,</span> <span class="nx">salt</span><span class="p">,</span> <span class="nx">numIterations</span><span class="p">,</span> <span class="mi">16</span><span class="p">);</span>
...
<span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs5</span><span class="p">.</span><span class="nx">pbkdf2</span><span class="p">(</span><span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">,</span> <span class="nx">salt</span><span class="p">,</span> <span class="nx">numIterations</span><span class="p">,</span> <span class="mi">16</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">derivedKey</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nx">p7</span><span class="p">.</span><span class="nx">content</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="dl">'</span><span class="s1">Hello</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">p7</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs7</span><span class="p">.</span><span class="nx">createSignedData</span><span class="p">();</span>
<span class="nx">p7</span><span class="p">.</span><span class="nx">content</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="dl">'</span><span class="s1">Some content to be signed.</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">);</span>
...
<span class="nx">p7</span><span class="p">.</span><span class="nx">sign</span><span class="p">({</span><span class="na">detached</span><span class="p">:</span> <span class="kc">true</span><span class="p">});</span>
...
<span class="c1">// encrypts a PrivateKeyInfo using a custom password and</span>
<span class="c1">// outputs an EncryptedPrivateKeyInfo</span>
<span class="kd">var</span> <span class="nx">encryptedPrivateKeyInfo</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">encryptPrivateKeyInfo</span><span class="p">(</span>
  <span class="nx">privateKeyInfo</span><span class="p">,</span> <span class="dl">'</span><span class="s1">myCustomPasswordHere</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span>
    <span class="na">algorithm</span><span class="p">:</span> <span class="dl">'</span><span class="s1">aes256</span><span class="dl">'</span><span class="p">,</span> <span class="c1">// 'aes128', 'aes192', 'aes256', '3des'</span>
  <span class="p">});</span>

<span class="c1">// decrypts an ASN.1 EncryptedPrivateKeyInfo that was encrypted</span>
<span class="c1">// with a custom password</span>
<span class="kd">var</span> <span class="nx">privateKeyInfo</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">decryptPrivateKeyInfo</span><span class="p">(</span>
  <span class="nx">encryptedPrivateKeyInfo</span><span class="p">,</span> <span class="dl">'</span><span class="s1">myCustomPasswordHere</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">pem</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">encryptRsaPrivateKey</span><span class="p">(</span><span class="nx">privateKey</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">pem</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">encryptRsaPrivateKey</span><span class="p">(</span><span class="nx">privateKey</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span><span class="na">legacy</span><span class="p">:</span> <span class="kc">true</span><span class="p">});</span>

<span class="c1">// decrypts a PEM-formatted, encrypted private key</span>
<span class="kd">var</span> <span class="nx">privateKey</span> <span class="o">=</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">decryptRsaPrivateKey</span><span class="p">(</span><span class="nx">pem</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">);</span>
...
<a href="https://en.wikipedia.org/wiki/Certificate_signing_request">PKCS#10</a>.</p>
...
<span class="kd">var</span> <span class="nx">keys</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pki</span><span class="p">.</span><span class="nx">rsa</span><span class="p">.</span><span class="nx">generateKeyPair</span><span class="p">(</span><span class="mi">2048</span><span class="p">);</span>
...
<span class="nx">csr</span><span class="p">.</span><span class="nx">setAttributes</span><span class="p">([{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">challengePassword</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">unstructuredName</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">My Company, Inc.</span><span class="dl">'</span>
<span class="p">},</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">extensionRequest</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">extensions</span><span class="p">:</span> <span class="p">[{</span>
    ...
    <span class="na">altNames</span><span class="p">:</span> <span class="p">[{</span>
      ...
      <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">test.domain.com</span><span class="dl">'</span>
    <span class="p">},</span> <span class="p">{</span>
      <span class="na">type</span><span class="p">:</span> <span class="mi">2</span><span class="p">,</span>
      <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">other.domain.com</span><span class="dl">'</span><span class="p">,</span>
    <span class="p">},</span> <span class="p">{</span>
      <span class="na">type</span><span class="p">:</span> <span class="mi">2</span><span class="p">,</span>
      <span class="na">value</span><span class="p">:</span> <span class="dl">'</span><span class="s1">www.domain.net</span><span class="dl">'</span>
    <span class="p">}]</span>
  <span class="p">}]</span>
<span class="p">}]);</span>
...
<span class="nx">csr</span><span class="p">.</span><span class="nx">getAttribute</span><span class="p">({</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">challengePassword</span><span class="dl">'</span><span class="p">});</span>

<span class="c1">// get extensions array</span>
<span class="nx">csr</span><span class="p">.</span><span class="nx">getAttribute</span><span class="p">({</span><span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">extensionRequest</span><span class="dl">'</span><span class="p">}).</span><span class="nx">extensions</span><span class="p">;</span>
...
to <code class="language-plaintext highlighter-rouge">forge.pkcs12.toPkcs12Asn1</code> using the <code class="language-plaintext highlighter-rouge">{algorithm: '3des'}</code> option.</p>
...
<span class="kd">var</span> <span class="nx">p12</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">pkcs12FromAsn1</span><span class="p">(</span><span class="nx">p12Asn1</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">// decrypt p12 using non-strict parsing mode (resolves some ASN.1 parse errors)</span>
<span class="kd">var</span> <span class="nx">p12</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">pkcs12FromAsn1</span><span class="p">(</span><span class="nx">p12Asn1</span><span class="p">,</span> <span class="kc">false</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">p12</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">pkcs12FromAsn1</span><span class="p">(</span><span class="nx">p12Asn1</span><span class="p">,</span> <span class="dl">''</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">friendlyName</span><span class="p">:</span> <span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span><span class="na">localKeyIdHex</span><span class="p">:</span> <span class="dl">'</span><span class="s1">7b59377ff142d0be4565e9ac3d396c01401cd879</span><span class="dl">'</span><span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">bags</span> <span class="o">=</span> <span class="nx">p12</span><span class="p">.</span><span class="nx">getBags</span><span class="p">({</span>
  <span class="na">friendlyName</span><span class="p">:</span> <span class="dl">'</span><span class="s1">test</span><span class="dl">'</span><span class="p">,</span>
...
<span class="kd">var</span> <span class="nx">p12Asn1</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">toPkcs12Asn1</span><span class="p">(</span>
  <span class="nx">privateKey</span><span class="p">,</span> <span class="nx">certificateChain</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">p12Asn1</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">pkcs12</span><span class="p">.</span><span class="nx">toPkcs12Asn1</span><span class="p">(</span>
  <span class="nx">privateKey</span><span class="p">,</span> <span class="nx">certificateChain</span><span class="p">,</span> <span class="dl">'</span><span class="s1">password</span><span class="dl">'</span><span class="p">,</span>
  <span class="p">{</span><span class="na">algorithm</span><span class="p">:</span> <span class="dl">'</span><span class="s1">3des</span><span class="dl">'</span><span class="p">});</span>
...
<span class="nx">a</span><span class="p">.</span><span class="nx">download</span> <span class="o">=</span> <span class="dl">'</span><span class="s1">example.p12</span><span class="dl">'</span><span class="p">;</span>
<span class="nx">a</span><span class="p">.</span><span class="nx">setAttribute</span><span class="p">(</span><span class="dl">'</span><span class="s1">href</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">data:application/x-pkcs12;base64,</span><span class="dl">'</span> <span class="o">+</span> <span class="nx">p12b64</span><span class="p">);</span>
<span class="nx">a</span><span class="p">.</span><span class="nx">appendChild</span><span class="p">(</span><span class="nb">document</span><span class="p">.</span><span class="nx">createTextNode</span><span class="p">(</span><span class="dl">'</span><span class="s1">Download</span><span class="dl">'</span><span class="p">));</span>
</code></pre></div></div>
  ...
  <span class="nx">asn1</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span> <span class="kc">true</span><span class="p">,</span> <span class="p">[</span>
    ...
    <span class="nx">asn1</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span> <span class="kc">true</span><span class="p">,</span> <span class="p">[</span>
      ...
      <span class="nx">asn1</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">OID</span><span class="p">,</span> <span class="kc">false</span><span class="p">,</span>
        <span class="nx">asn1</span><span class="p">.</span><span class="nx">oidToDer</span><span class="p">(</span><span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">[</span><span class="dl">'</span><span class="s1">rsaEncryption</span><span class="dl">'</span><span class="p">]).</span><span class="nx">getBytes</span><span class="p">()),</span>
      <span class="c1">// parameters (null)</span>
      <span class="nx">asn1</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">NULL</span><span class="p">,</span> <span class="kc">false</span><span class="p">,</span> <span class="dl">''</span><span class="p">)</span>
    <span class="p">]),</span>
...
<span class="kd">var</span> <span class="nx">derOidBuffer</span> <span class="o">=</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">oidToDer</span><span class="p">(</span><span class="dl">'</span><span class="s1">1.2.840.113549.1.1.5</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">publicKeyValidator</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo</span><span class="dl">'</span><span class="p">,</span>
  ...
  <span class="na">captureAsn1</span><span class="p">:</span> <span class="dl">'</span><span class="s1">subjectPublicKeyInfo</span><span class="dl">'</span><span class="p">,</span>
  <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
    <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo.AlgorithmIdentifier</span><span class="dl">'</span><span class="p">,</span>
    <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
    <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span>
    <span class="na">constructed</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
    <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
      <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">AlgorithmIdentifier.algorithm</span><span class="dl">'</span><span class="p">,</span>
      <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
      ...
      <span class="na">capture</span><span class="p">:</span> <span class="dl">'</span><span class="s1">publicKeyOid</span><span class="dl">'</span>
    <span class="p">}]</span>
  <span class="p">},</span> <span class="p">{</span>
    <span class="c1">// subjectPublicKey</span>
    <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo.subjectPublicKey</span><span class="dl">'</span><span class="p">,</span>
    <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
    ...
    <span class="na">value</span><span class="p">:</span> <span class="p">[{</span>
      <span class="c1">// RSAPublicKey</span>
      <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">SubjectPublicKeyInfo.subjectPublicKey.RSAPublicKey</span><span class="dl">'</span><span class="p">,</span>
      <span class="na">tagClass</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Class</span><span class="p">.</span><span class="nx">UNIVERSAL</span><span class="p">,</span>
      <span class="na">type</span><span class="p">:</span> <span class="nx">asn1</span><span class="p">.</span><span class="nx">Type</span><span class="p">.</span><span class="nx">SEQUENCE</span><span class="p">,</span>
      <span class="na">constructed</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
      <span class="na">optional</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
      <span class="na">captureAsn1</span><span class="p">:</span> <span class="dl">'</span><span class="s1">rsaPublicKey</span><span class="dl">'</span>
    <span class="p">}]</span>
  <span class="p">}]</span>
<span class="p">};</span>
...
<span class="k">if</span><span class="p">(</span><span class="o">!</span><span class="nx">asn1</span><span class="p">.</span><span class="nx">validate</span><span class="p">(</span>
  ...
  <span class="k">throw</span> <span class="dl">'</span><span class="s1">ASN.1 object is not a SubjectPublicKeyInfo.</span><span class="dl">'</span><span class="p">;</span>
<span class="p">}</span>
...
<span class="k">if</span><span class="p">(</span><span class="nx">oid</span> <span class="o">!==</span> <span class="nx">pki</span><span class="p">.</span><span class="nx">oids</span><span class="p">[</span><span class="dl">'</span><span class="s1">rsaEncryption</span><span class="dl">'</span><span class="p">])</span> <span class="p">{</span>
  <span class="k">throw</span> <span class="dl">'</span><span class="s1">Unsupported OID.</span><span class="dl">'</span><span class="p">;</span>
<span class="p">}</span>
...
<span class="nx">md</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="dl">'</span><span class="s1">The quick brown fox jumps over the lazy dog</span><span class="dl">'</span><span class="p">);</span>
...
<span class="nx">hmac</span><span class="p">.</span><span class="nx">start</span><span class="p">(</span><span class="dl">'</span><span class="s1">sha1</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">Jefe</span><span class="dl">'</span><span class="p">);</span>
<span class="nx">hmac</span><span class="p">.</span><span class="nx">update</span><span class="p">(</span><span class="dl">'</span><span class="s1">what do ya want for nothing?</span><span class="dl">'</span><span class="p">);</span>
...
<span class="nx">forge</span><span class="p">.</span><span class="nx">prime</span><span class="p">.</span><span class="nx">generateProbablePrime</span><span class="p">(</span><span class="nx">bits</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">num</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">random prime</span><span class="dl">'</span><span class="p">,</span> <span class="nx">num</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="mi">16</span><span class="p">));</span>
<span class="p">});</span>
...
<span class="kd">var</span> <span class="nx">options</span> <span class="o">=</span> <span class="p">{</span>
  <span class="na">algorithm</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">name</span><span class="p">:</span> <span class="dl">'</span><span class="s1">PRIMEINC</span><span class="dl">'</span><span class="p">,</span>
...
<p>Provides a <a href="https://en.wikipedia.org/wiki/Fortuna_(PRNG)">Fortuna</a>-based cryptographically-secure pseudo-random number
generator, to be used with a cryptographic function backend, e.g. <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a>. An
implementation using <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">AES</a> as a backend is provided. An API for collecting
...
<span class="kd">var</span> <span class="nx">buffer</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span> <span class="dl">'</span><span class="s1">raw</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">// create a byte buffer from utf8 bytes</span>
<span class="kd">var</span> <span class="nx">buffer</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span> <span class="dl">'</span><span class="s1">utf8</span><span class="dl">'</span><span class="p">);</span>
...
<span class="kd">var</span> <span class="nx">nodeBuffer</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="k">from</span><span class="p">(</span><span class="nx">forgeBuffer</span><span class="p">.</span><span class="nx">getBytes</span><span class="p">(),</span> <span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">);</span>

<span class="c1">// convert a Node.js Buffer into a forge buffer</span>
<span class="c1">// make sure you specify the encoding as 'binary'</span>
<span class="kd">var</span> <span class="nx">nodeBuffer</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="k">from</span><span class="p">(</span><span class="dl">'</span><span class="s1">CAFE</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">hex</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">forgeBuffer</span> <span class="o">=</span> <span class="nx">forge</span><span class="p">.</span><span class="nx">util</span><span class="p">.</span><span class="nx">createBuffer</span><span class="p">(</span><span class="nx">nodeBuffer</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="dl">'</span><span class="s1">binary</span><span class="dl">'</span><span class="p">));</span>
</code></pre></div></div>
...
<p>The <a href="/myportfolio.client/node_modules/node-forge/flash/">flash README</a> provides details on rebuilding the
...
itself, and so on.</li>
  <li>If using pre-built bundles from <a href="https://www.npmjs.com/">NPM</a>, another CDN, or similar, be aware
someone else ran the tools to create those files.</li>
  <li>Use a secure transport channel such as <a href="https://en.wikipedia.org/wiki/Transport_Layer_Security">TLS</a> to load scripts and consider
...
<ul>
  <li>https://digitalbazaar.com/2010/07/20/javascript-tls-1/</li>
  <li>https://digitalbazaar.com/2010/07/20/javascript-tls-2/</li>
</ul>
...
<ul>
  ...
  <li>IRC: <a href="https://webchat.freenode.net/?channels=#forgejs">#forgejs</a> on <a href="https://libera.chat/">Libera.Chat</a> (people may also be on <a href="https://freenode.net/">freenode</a> for
