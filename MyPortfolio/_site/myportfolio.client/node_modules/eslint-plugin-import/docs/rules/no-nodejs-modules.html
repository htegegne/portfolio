...
<title>import/no-nodejs-modules | portfolio</title>
<meta name="generator" content="Jekyll v3.9.3" />
<meta property="og:title" content="import/no-nodejs-modules" />
<meta property="og:locale" content="en_US" />
<link rel="canonical" href="http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-import/docs/rules/no-nodejs-modules.html" />
<meta property="og:url" content="http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-import/docs/rules/no-nodejs-modules.html" />
<meta property="og:site_name" content="portfolio" />
<meta property="og:type" content="website" />
<meta name="twitter:card" content="summary" />
<meta property="twitter:title" content="import/no-nodejs-modules" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","headline":"import/no-nodejs-modules","url":"http://localhost:4000/myportfolio.client/node_modules/eslint-plugin-import/docs/rules/no-nodejs-modules.html"}</script>
<!-- End Jekyll SEO tag -->
...
<!-- end custom head snippets -->
  ...
  <body>
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <h1 id="importno-nodejs-modules">import/no-nodejs-modules</h1>
...
<ul>
  <li><code class="language-plaintext highlighter-rouge">allow</code>: Array of names of allowed modules. Defaults to an empty array.</li>
</ul>
...
<span class="cm">/* eslint import/no-nodejs-modules: ["error", {"allow": ["path"]}] */</span>
<span class="k">import</span> <span class="nx">path</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">path</span><span class="dl">'</span><span class="p">;</span>
</code></pre></div></div>
